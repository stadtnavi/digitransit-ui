...
const translations = {
  da: {
    ...
    'bicycle-availability': '{amount} Cykler tilgængelige',
    ...
    'bicycle-distance-duration': 'Cykle {duration} ({distance})',
    'bicyclewalk-distance-duration': 'Tril cyklen {duration} ({distance})',
    ...
    'rent-bicycle-at': 'Lej cykel fra stativ {station}',
  ...
  de: {
    ...
    'current-alerts': 'Aktuelle Verkehrsinfo',
    ...
    'funicular': 'Seilbahn / Zahnradbahn',
    ...
    imprint: 'Impressum',
    privacy: 'Datenschutz',
    'rent-bicycle-at': 'Leihrad ausleihen:',
    ...
    'map-layer-sharing-bicycle': 'Bikesharing',
    'map-layer-sharing-cargo_bicycle': 'Lastenrad-Sharing',
    'map-layer-sharing-car': 'Carsharing',
    'map-layer-sharing-taxi': 'Taxi-Stationen',
    'map-layer-sharing-scooter': 'E-Scooter-Sharing',
    'map-layer-category-public-transit': 'Öffentlicher Nahverkehr',
    'map-layer-category-bicycle-car': 'Fahrrad & Auto',
    'map-layer-category-sharing': 'Sharing-Angebote',
    'map-layer-category-leisure-tourism': 'Freizeit & Tourismus',
    ...
    'bicycle-availability': '{amount, plural, =0 {Keine Fahrräder} one {Ein Fahrrad} other {# Fahrräder}} verfügbar',
    ...
    'carpool-details-link': 'Mitfahrt vereinbaren über {agency}',
    ...
    'bicycle-start-using': 'Beginne Leihrad-Nutzung',
    'bicycle-start-using-info': 'Mehr Informationen bei',
    'citybike-station': 'Leihrad-Station {stationId}',
    'bicycle-station-no-id': 'Leihrad-Station',
    'cargo_bicycle-start-using': 'Beginne Lastenrad-Nutzung',
    'cargo_bicycle-start-using-info': 'Mehr Informationen bei',
    'cargo_bicycle-station-no-id': 'Lastenrad-Station',
    'car-start-using': 'Beginne Carsharing-Nutzung',
    'car-start-using-info': 'Mehr Informationen bei',
    'car-station-no-id': 'Carsharing-Station',
    ...
    'bicycle-distance-duration': 'Radfahren: {duration} ({distance})',
    'bicyclewalk-distance-duration': 'Fahrrad schieben: {duration} ({distance})',
    ...
    'itinerary-summary-row.first-leg-start-time-citybike':
      'Abfahrt um {firstDepartureTime} von {firstDepartureStop} (Leih-Station)',
    ...
    'map-layer-vehicles': 'ÖPNV-Positionen',
    'map-layer-weather-stations': 'Wettersensoren',
    'menu-faq': 'FAQ',
    ...
    'network-error-itineraries-summary': 'Wir konnten leider keine Reisevorschläge abrufen, weil Ihre Internetverbindung unterbrochen oder der Server nicht erreichbar ist. Bitte versuchen Sie es später erneut.',
    next: 'Nächste',
    ...
    'car-availability': '{amount, plural, =0 {Kein Car-Sharing-Fahrzeug} one {Üblicherweise ein Car-Sharing-Fahrzeug} other {Bis zu # Car-Sharing-Fahrzeuge}} verfügbar. Genaue Verfügbarkeit vorab prüfen.',
    'car-start-using': 'Buchen Sie ein Carsharing-Fahrzeug',
    'car-using-info': 'Mehr Informationen bei',
    'cargo_bicycle-availability': '{amount, plural, =0 {Keine Lastenräder} one {Ein Lastenrad} other {# Lastenräder}} verfügbar',
    'cargo_bicycle-content-description' : 'Lastenrad Station',
    'cargo_bicycle-start-using': 'Buchen Sie ein Lastenrad',
    'cargo_bicycle-start-using-info': 'Mehr Informationen bei',
    ...
    'pick-rental-mode': 'Sharing-Angebote',
    'pick-street-mode': 'Meine Reiseoptionen',
    'place-route-or-keyword': 'Adresse oder Haltestelle',
    platform: 'Steig',
    'platform-num': 'Steig {platformCode}',
    'platform-short': 'St. {platformCode}',
    'platform-short-no-num': 'St.',
    ...
    'rent-car-at': 'Carsharing-Fahrzeug ausleihen:',
    'rent-scooter-at': 'Scooter ausleihen:',
    'required-ticket': 'Benötigtes Ticket',
    'return-bicycle-to': 'Das Fahrrad zurückgeben:',
    ...
    run: 'Schnell',
    save: 'Speichern',
    'scooter-availability': '{amount, plural, =0 {Keine E-Scooter} one {Ein E-Scooter} other {# E-Scooter}} verfügbar',
    'scooter-distance-duration': 'E-Scooter {distance} fahren ({duration})',
    ...
    share: 'Reise teilen',
    'sharing-operators-car-header': 'Car-Sharing',
    'sharing-operators-cargo_bicycle-header': 'Leih-Lastenräder',
    'sharing-operators-bicycle-header': 'Leihräder',
    'sharing-operators-scooter-header': 'Leih-Scooter',
    'sharing-operators-moped-header': 'Leih-Mopeds',
    show: 'zeigen',
  ...
  en: {
    ...
    'direction': 'To ',
    'car-start-using': 'Book a shared car',
    'car-start-using-info': 'More information at',
    'car-availability': '{amount} Shared cars available',
    "car-station-no-id": "Car Sharing Station",
    'cargo_bicycle': 'Cargo bike',
    'cargo_bicycle-booking-link' : 'Book',
    'cargo_bicycle-content-description' : 'Cargo bike station',
    'cargo_bicycle-start-using': 'Book a cargo bike',
    'cargo_bicycle-start-using-info': 'More information at',
    'cargo_bicycle-station-no-id': 'Cargo bike rental station',
    ...
    'map-layer-weather-stations': 'Weather sensors',
    'map-layer-category-public-transit': 'Public Transit',
    'map-layer-category-bicycle-car': 'Bicycle & Car',
    'map-layer-category-sharing': 'Sharing',
    'map-layer-category-leisure-tourism': 'Leisure & Tourism',
    'map-layer-category-shopping-services': 'Shopping & Services',
    'map-layer-category-public-facilities': 'Public Facilities',
    'map-layer-category-health-social-services': 'Health & Social Services',
    ...
    'cargo_bicycle-availability': '{amount} Cargo bikes available at the station right now',
    ...
    'carpool-details-link': 'Contact driver via {agency}',
    ...
    'bicycle-start-using': 'Start using rental bikes',
    'bicycle-start-using-info': 'More information at',
    'citybike-station': 'Bike station {stationId}',
    'bicycle-station-no-id': 'Bike station',
    ...
    'bicycle-distance-duration': 'Cycle {duration} ({distance})',
    'bicyclewalk-distance-duration': 'Walk your bike {duration} ({distance})',
    // eslint-disable-next-line sort-keys
    ...
    'from-subway': 'subway',
    frontpage: 'Frontpage',
    funicular: 'Funicular / rack railway',
    ...
    'map-layer-vehicles': 'Public transit positions',
    ...
    'rent-bicycle-at': 'Fetch a rental bike:',
    'rent-car-at': 'Rent a car:',
    ...
    run: 'Run',
    save: 'Save',
    'scooter-availability': '{amount} Kick scooters available at the station right now',
  ...
  es: {
    ...
    'bicycle-availability': '{amount} Bicicletas disponibles actualmente en la estación',
    'bike-station-disabled': 'Pyöräasema ei ole käytössä.',
    bus: 'Bus',
    'bus-with-route-number': 'Bus {routeNumber} {headSign}',
    buy: 'Buy',
    ...
    'bicycle-distance-duration': 'Ir en bici {duration} ({distance})',
    ...
    'rent-bicycle-at': 'Alquile una bici en la estación {station}',
    ...
    'bicycle-availability': '{amount} Pyöriä asemalla juuri nyt',
    ...
    'bicycle-start-using': 'Ota kaupunkipyörät käyttöön',
    'bicycle-start-using-info': 'Lisätietoja',
    'citybike-station': 'Kaupunkipyöräasema {stationId}',
    'bicycle-station-no-id': 'Kaupunkipyöräasema',
    ...
    'bicycle-distance-duration': 'Pyöräile {duration} ({distance})',
    'bicyclewalk-distance-duration': 'Taluta pyörää {duration} ({distance})',
    // eslint-disable-next-line sort-keys
    ...
    run: 'Juoksu',
    save: 'Tallenna',
    'scooter-availability': '{amount} Potkulautoja asemalla juuri nyt',
  ...
  fr: {
    "about-service-feedback": "Au sujet du service et feedback", 
    "about-these-pages": "À propos des sites Web", 
    "about-this-service": "À propos de ce service", 
    "accept-carpool-policy": "J'ai lu et accepté la <a href=\"{policyUrl}\" cible=\"_blank\" style=\"color: #92bc05\">Politique de confidentialité</a> et les <a href=\"{termsUrl}\" cible=\"blank\" style=\"color: #92bc05\">termes d'utilisation</a> de Fahrgemeinschaft. de.", 
    access_with: "accès avec", 
    accessibility: "Accessibilité", 
    "accessibility-limited": "Accessible aux fauteuils roulants", 
    "accessibility-nolimit": "Aucune limite", 
    "accessibility-routing-disabled": "En raison d'un manque de données sur l'accessibilité, nous sommes malheureusement incapables de fournir des routes sans obstacles pour le moment.", 
    "accessibility-statement": "Information sur l'accessibilité", 
    "add-favourite-bikeStation-failed-heading": "L'enregistrement de la station citybike a échoué", 
    "add-favourite-place-failed-heading": "Impossible d'enregistrer l'emplacement", 
    "add-favourite-route-failed-heading": "La sauvegarde de l'itinéraire a échoué", 
    "add-favourite-station-failed-heading": "Sauver la station a échoué.", 
    "add-favourite-stop-failed-heading": "La sauvegarde de l'arrêt a échoué", 
    "add-home": "Ajouter la maison", 
    "add-itinerary-via-point": "Ajouter une étape au trajet", 
    "add-location-to-favourites": "Ajouter l'endroit aux favoris", 
    "add-to-favourites": "Ajouter à vos favoris", 
    "add-via-button-label": "Ajouter par point", 
    "add-via-duration-button-label": "Régler la durée d'arrêt au point {{index}}", 
    "add-via-duration-button-label-close": "Fermer le sélecteur de durée d'arrêt via point {{index}}", 
    "add-via-duration-button-label-open": "Ouvrir le sélecteur de durée d'arrêt au point {{index}}", 
    "add-work": "Ajouter le travail", 
    "additional-info": "Les informations apparaîtront ici…", 
    address: "Adresse", 
    "address-or-stop": "Adresse ou arrêt", 
    agency: "Opérateur", 
    "air-temperature": "Température de l'air", 
    airplane: "Vol", 
    "airplane-with-route-number": "Vol {routeNumber}", 
    "airport-check-in": "Enregistrer les bagages chez {agency}", 
    "airport-collect-luggage": "Récupérer vos bagages", 
    "airport-security-check-go-to-gate": "Passez par le contrôle de sécurité jusqu'à la porte d'embarquement", 
    "alert:bikerental:free-floating-drop-off": "La destination n'est pas une zone de dépôt désignée. La location ne peut pas être terminée ici. Veuillez vérifier les conditions générales pour obtenir des frais supplémentaires.", 
    all: "Tous", 
    "all-routes": "Toutes lignes", 
    "all-routes-disabled": "Aucune ligne", 
    "approx-meters": "{approxDistance} m", 
    "aria-itinerary-summary": "Durée totale du trajet {duration}. Départ à {inFuture} {departureTime} et arrivée à {arrivalTime}", 
    "aria-itinerary-summary-bike-distance": "Total du parcours à vélo {duration}, {distance}", 
    "aria-itinerary-summary-car-distance": "Total conduite {duration}, {distance}", 
    "aria-itinerary-summary-walk-distance": "Total de la marche {duration}, {distance}", 
    "arrive-leave": "Arrivée ou départ à l'heure choisie", 
    "arriving-at": "Arrivée", 
    "arriving-soon": "Maintenant", 
    "as-destination": "Destination", 
    "as-origin": "Origine", 
    "as-viapoint": "Point de passage", 
    "at-time": "à", 
    ...
    bicycle: "Vélo", 
    "bicycle-charging-station": "Station de recharge pour vélos", 
    "bicycle-distance-duration": "Vélo {duration} ({distance})", 
    "bicycle-parking": "Stationnement à vélo", 
    "bicycle-parking-covered": "couvert", 
    "bicycle-parking-filter": "Options de stationnement à vélo", 
    "bicycle-parking-filter-all": "Toutes les places de stationnement", 
    "bicycle-parking-filter-freeOnly": "Stations gratuites seulement", 
    "bicycle-parking-filter-securePreferred": "Préféré sécurisé", 
    "bicycle-parking-garage": "Parking à vélos", 
    "bicycle-parking-lockers": "Casiers à vélos", 
    "bicycle-parking-shed": "Station de collecte de vélos", 
    "bicycle-walk-from-transit": "Descendez du {transportMode} avec votre vélo et marchez le sur {distance} ({duration})", 
    "bicycle-walk-from-transit-no-duration": "Sortez votre vélo du {transportMode}", 
    "bicycle-walk-to-transit": "Marchez votre vélo pour {distance} ({duration}) et prenez-le sur le {transportMode}", 
    "bicycle-walk-to-transit-no-duration": "Marchez votre vélo jusqu'au {transportMode}", 
    bicycle_frame_lock: "Antivol de cadre", 
    bicycle_walk: "Marcher à vélo", 
    "bicyclewalk-distance-duration": "Marcher pied à terre sur {duration} ({distance})", 
    "bike-and-ride": "Vélo et transport en commun", 
    ...
    "bike-only": "Cyclisme seulement", 
    "bike-park": "Park & Ride pour les vélos", 
    "bike-park-disclaimer": "Vous pouvez facilement combiner le vélo et les transports en commun: laissez votre vélo dans un Park & Ride et continuez en train, bus, métro ou tram. Le stationnement à vélo est gratuit et il n'y a pas de limite de temps.", 
    "bike-park-disclaimer-header": "Garez votre vélo", 
    "bike-park-disclaimer-link": "En savoir plus sur le Park and Ride pour les vélos", 
    "bike-station-disabled": "La station de vélo est hors service", 
    "bikes-available": "{amount} vélos à la station", 
    ...
    "book-locker": "Réserver une place de stationnement", 
    bus: "Bus", 
    "bus-express": "Bus express", 
    "bus-local": "Bus de quartier", 
    "bus-with-route-number": "Bus {routeNumber} {headSign}", 
    buy: "Acheter", 
    ...
    cancel: "Annuler", 
    canceled: "Annulé", 
    "canceled-itineraries-amount": "Autre {itineraryMontant, pluriel, =1 {1 itinéraire annulé} autre {{itineraryAmount} itinéraires annulés}}", 
    "canceled-itineraries-amount-hide": "Cacher les itinéraires annulés ({itineraryAmount})", 
    "canceled-legs": "Départs annulés sur l'itinéraire", 
    car: "Voiture", 
    "car-availability": "{amount} Voitures partagées disponibles", 
    "car-charging-station": "Station de recharge pour voitures", 
    "car-distance-duration": "Conduire {duration} ({distance})", 
    "car-only": "Voiture seulement", 
    "car-park-capacity-alert": "Ce parking est proche de la capacité. Veuillez prévoir un délai supplémentaire pour votre voyage", 
    "car-park-disclaimer": "Vous pouvez facilement combiner voiture et transports en commun: laissez votre voiture dans un parc et continuez en train, bus, métro ou tram. Le parking est gratuit et il n'y a pas de limite de temps.", 
    "car-park-disclaimer-header": "Garez votre voiture", 
    "car-park-disclaimer-link": "En savoir plus sur Park & Ride", 
    "car-park-full": "Exclure les parkings avec quelques espaces", 
    "car-park-ride-itinerary": "Aucune route n'a été trouvée dans les transports publics uniquement.", 
    "car-sharing-station-no-id": "Station de partage de voiture", 
    "car-start-using": "Réservez une voiture partagée", 
    "car-start-using-info": "Plus d'informations à", 
    "car-station-no-id": "Station d'autopartage",
    car_park: "parc relais", 
    "card-header-back-to-result-list": "Retourner aux résultats", 
    cargo_bicycle: "Vélo cargo", 
    "cargo_bicycle-availability": "{amount} Vélos cargo disponibles à la station dès maintenant", 
    "cargo_bicycle-booking-link": "Réserver", 
    "cargo_bicycle-capacity-available": "{available} de {capacity} disponible", 
    "cargo_bicycle-capacity-in-total": "Capacité: {capacity} vélos de fret/vélos cargo", 
    "cargo_bicycle-capacity-no-data": "Aucune donnée sur la capacité disponible", 
    "cargo_bicycle-content-description": "Station de vélos cargo", 
    "cargo_bicycle-start-using": "Réservez un vélo cargo", 
    "cargo_bicycle-start-using-info": "Plus d'informations à", 
    "cargo_bicycle-station-no-id": "Station de location de vélos cargo", 
    carpool: "Covoiturage", 
    "carpool-distance-duration": "Roule {duration} ({distance})", 
    "carpool-legal-notice": "Ceci est une offre du prestataire externe ride2Go GmbH.", 
    "carpool-only": "Covoiturage seulement", 
    "carpool-with-route-number": "Route de covoiturage {routeNumber} vers {headsign}", 
    cause: "Cause", 
    "char-left": "caractères", 
    "charging-free": "La recharge est gratuite", 
    "charging-not-free": "Recharge payante", 
    "charging-spaces-available": "{available} de {capacity} emplacements de chargement disponibles", 
    "charging-spaces-in-total": "{capacity} emplacements de chargement", 
    "charging-spaces-no-data": "Aucune donnée sur la capacité disponible", 
    "choose-freely": "Facultatif", 
    "choose-stop": "Merci de choisir la ligne", 
    "choose-stop-or-vehicle": "Select vehicle or stop", 
    "choose-vehicle": "Sélectionner un véhicule", 
    citybike: "Vélo en libre service", 
    "bicycle-availability": "{amount} Vélos disponibles en station", 
    "citybike-buy-season": "Acheter un billet pour la journée, le mois ou l'année", 
    "citybike-distance-duration": "Vélo en libre-service {duration} ({distance})", 
    "citybike-duration-general-header": "Des frais supplémentaires s'appliquent à plusieurs tronçons de route à compléter par un vélo de ville.", 
    "citybike-duration-info": "Vous pouvez utiliser le vélo de ville pendant jusqu'à {duration} minutes à la fois, après quoi vous serez facturé supplémentaire.", 
    "citybike-duration-info-header": "La section de route à compléter par un vélo de ville prend plus de {duration} minutes.", 
    "citybike-duration-info-short": "La section d'itinéraire prend plus de {duration} min. Des frais supplémentaires s'appliquent.", 
    "citybike-network-headers": "Vélos de ville", 
    "citybike-purchase-link": "Acheter", 
    "citybike-register-required": "L'utilisation du Vélo en libre service nécessite une inscription", 
    "citybike-return-full": "Rendre le vélo de ville?", 
    "citybike-return-full-link": "Comment rendre un vélo quand une station de vélo est pleine?", 
    "bicycle-start-using": "Commencez à utiliser des vélos urbains", 
    "bicycle-start-using-info": "Informations supplémentaires", 
    "bicycle-station": "Station cyclable {stationId}", 
    "bicycle-station-no-id": "Station cyclable", 
    "clear-button-label": "Supprimer", 
    close: "Fermer", 
    "close-favourite-module": "Fermez le module Favoris", 
    "close-settings": "Fermer la fenêtre et enregistrer les paramètres", 
    closed: "Fermé", 
    "contact-information": "Contacter {contactName}", 
    "continue": "Continuer", 
    "copy-code": "Copier le code", 
    covered: "Couvert", 
    "create-account": "Créer un compte {contactName}", 
    "create-embedded-search": "Créer un élément de recherche de route", 
    "create-stop-monitor": "Créer un moniteur de départ", 
    currentposition: "Situation actuelle", 
    "cycling-map-legend-bike-lane": "piste cyclable", 
    "cycling-map-legend-bike-parking": "stationnement de vélos", 
    "cycling-map-legend-bike-parking-covered": "parking de vélos couvert", 
    "cycling-map-legend-bike-parking-lockable": "Stationnement sécurisé pour vélos", 
    "cycling-map-legend-bike-repair": "installation de réparation de vélo", 
    "cycling-map-legend-local-cycling-route": "piste cyclable locale", 
    "cycling-map-legend-major-cycling-route": "grande route cyclable", 
    "cycling-map-legend-title": "légende de la carte", 
    datasource: "Source des données", 
    datasources: "Sources des données", 
    date: "Date", 
    day: "Jour", 
    "delete": "Supprimer", 
    "delete-favourite-failed-heading": "Impossible de supprimer l'enregistrement", 
    "departure-is-canceled": "{modeInfo} {from}–{to} à {time} est annulé", 
    "departure-is-canceled-airplane": "Vol {shortName}", 
    "departure-is-canceled-bus": "Bus {shortName}", 
    "departure-is-canceled-ferry": "Ferry {shortName}", 
    "departure-is-canceled-rail": "Train {shortName}", 
    "departure-is-canceled-subway": "Service de métro {shortName}", 
    "departure-is-canceled-tram": "Tram {shortName}", 
    "departure-list-update.sr-instructions": "La liste des départs et des heures de départ à venir sera mise à jour en temps réel.", 
    "departure-page-sr": "Informations sur le voyage {shortName} {destination} {time}", 
    "departure-time-in-minutes": "{minutes} min", 
    "departure-time-sr": "{when} horloge {time}. {realTime}", 
    departures: "Départs", 
    "departures-by-hour": "Départs par heure", 
    "departures-by-hour-minutes-route": "(minutes/route)", 
    "departures-not-found": "Malheureusement, aucun calendrier n'a été trouvé pour l'arrêt que vous avez sélectionné", 
    "departures-not-found-time-threshold": "Malheureusement, aucun calendrier n'a été trouvé pour l'arrêt que vous avez sélectionné. Il est possible que le jour que vous cherchiez soit trop tard. S'il vous plaît essayez encore plus près de l'heure de votre voyage", 
    description: "Trouvez un réseau de transport public pour voyager loin ou à proximité", 
    destination: "Destination", 
    "destination-defined": "Destination définié", 
    ...
    "disruptions-and-diversions": "Perturbations et détournements", 
    "disruptions-tab.sr-disruptions": "Une ou plusieurs perturbations connues", 
    "disruptions-tab.sr-no-disruptions": "Aucune perturbation connue", 
    "distance-between": "Distance {distance1} m — {distance2} m", 
    "distance-total": "Distance totale", 
    "distance-under": "Distance inférieure à {distance} m", 
    earlier: "Plus tôt", 
    "edit-favourites": "Éditer les favoris", 
    "elevation-gained-total": "En montée", 
    "elevation-lost-total": "En descente", 
    "embedded-search.choose-language": "Langue", 
    "embedded-search.choose-mode": "Moyens de transport", 
    "embedded-search.choose-width-component": "Largeur de l'encastrement", 
    "embedded-search.form-heading": "Outils d'integration", 
    engine_ignition_aid: "Aide au démarrage du moteur", 
    english: "Anglais", 
    "exclude-full-carparks": "Exclure les parkings complets", 
    explanations: "Explication", 
    "extra-info": "Plus d'informations", 
    "fares-disclaimer": "Informations sur les tarifs fournies par la Nahverkehrsgesellschaft Baden-Wurtemberg mbH (NVBW). Aucune responsabilité pour l'exactitude des informations.", 
    "favourite-failed-text": "Veuillez réessayer plus tard.", 
    "favourite-target": "Destination favorite", 
    ferry: "Ferry", 
    "ferry-with-route-number": "Ferry {routeNumber} {headSign}", 
    "fetch-new-route": "Trouvez une nouvelle route", 
    finnish: "Finnois", 
    "free-of-charge": "Gratuit", 
    "from-ferry": "ferry", 
    "from-rail": "train", 
    "from-station": "de la station", 
    "from-stop": "de l'arrêt", 
    "from-subway": "métro", 
    frontpage: "Page d'accueil", 
    funicular: "Funiculaire", 
    "generic-cancelation": "{mode} {route} {headsign} à {time} est annulé.", 
    "generic-error": "Une erreur est survenue", 
    "geolocate-yourself": "Se localiser", 
    "geolocation-denied-heading": "Veuillez autoriser l'accès à votre positionnement", 
    "geolocation-denied-text": "La positionnement n'est pas autorisée. Merci de vérifier votre navigateur/téléphone", 
    "geolocation-failed-heading": "Positionnement échouée", 
    ...
    "give-route": "Chercher une connexion", 
    hour: "Heure", 
    "hour-short": "h", 
    "how-to-rate-service": "Comment évalueriez-vous le service?", 
    hsl_mobile_ticket: "Billet mobile HSL", 
    hsl_ticket: "Billet HSL", 
    hsl_travel_card: "Carte HSL", 
    imprint: "Empreinte", 
    "in-addition": "En plus", 
    "index.title": "Planificateur de voyage", 
    inquiry: "Répondre aux questions pour développer le service", 
    instructions: "Instructions", 
    "is-open": "Ouvert:", 
    "itinerary-details.biking-leg": "Au cycle {time} {distance} de {origin} à {to} {destination}. Durée estimée {duration}", 
    "itinerary-details.car-leg": "À {time} lecteur {distance} de {origin} à {to} {destination}. Durée estimée {duration}", 
    "itinerary-details.carpool-leg": "À {time} voyagez {distance} par covoiturage de {origin} à {to} {destination}. Durée estimée {duration}", 
    "itinerary-details.end-leg": "À {time} arriver à destination {destination}.", 
    "itinerary-details.route-has-info-alert": "La route a des alertes.", 
    "itinerary-details.route-has-severe-alert": "La route a des perturbations.", 
    "itinerary-details.route-has-unknown-alert": "La route a des perturbations.", 
    "itinerary-details.route-has-warning-alert": "La route a des perturbations.", 
    "itinerary-details.scooter-leg": "À {time} roulez votre scooter {distance} de {origin} à {destination}. Durée estimée {duration}", 
    "itinerary-details.transit-leg-part-1": "À {time} {realtime} prendre", 
    "itinerary-details.transit-leg-part-2": "de stop {startStop} {startZoneInfo} {trackInfo} pour arrêter {endStop} {endZoneInfo}. Durée estimée {duration}", 
    "itinerary-details.via-leg": "{arrivalTime} arrive par le point {viaPoint}. {leaveAction}", 
    "itinerary-details.walk-leg": "À {time} marcher {distance} de {origin} à {to} {destination}. Durée estimée {duration}", 
    ...
    "itinerary-in-the-past": "La recherche d'itinéraires se situe dans une période antérieure.", 
    "itinerary-in-the-past-link": "Départ maintenant ›", 
    "itinerary-in-the-past-title": "Les options de parcours ne peuvent pas être affichées", 
    "itinerary-page.description": "Itinéraire", 
    "itinerary-page.hide-details": "Masquer les détails de l'itinéraire", 
    "itinerary-page.itineraries-loaded": "Résultats de la recherche chargés", 
    "itinerary-page.itineraries-updated": "Résultats de la recherche mis à jour", 
    "itinerary-page.loading-itineraries": "Téléchargement des résultats de recherche", 
    "itinerary-page.show-details": "Afficher les détails de l'itinéraire", 
    "itinerary-page.show-details-label": "Afficher l'itinéraire {number} détails", 
    "itinerary-page.title": "Itinéraire", 
    "itinerary-page.update-alert": "Résultats de la recherche mis à jour", 
    "itinerary-summary-page-street-mode.update-alert": "Mise à jour des résultats de la marche et du vélo", 
    "itinerary-summary-page.description": "Trajet recommandé", 
    "itinerary-summary-page.title": "Trajet recommandé", 
    "itinerary-summary-row.biking-distance": "Distance totale à vélo {totalDistance}.",
    'itinerary-summary-row.steps.direction.DEPART': 'Allez sur {street} {direction}',
    'itinerary-summary-row.steps.direction.HARD_LEFT':
      'Tournez très à gauche dans {street}',
    'itinerary-summary-row.steps.direction.LEFT': 'Tournez à gauche dans {street}',
    'itinerary-summary-row.steps.direction.SLIGHTLY_LEFT':
      'Restez légèrement à gauche sur {street}',
    'itinerary-summary-row.steps.direction.RIGHT': 'Tournez à droite onto {street}',
    'itinerary-summary-row.steps.direction.SLIGHTLY_RIGHT':
      'Restez légèrement à droite sur {street}',
    'itinerary-summary-row.steps.direction.HARD_RIGHT':
      'Tournez très à droite dans {street}',
    'itinerary-summary-row.steps.direction.CONTINUE': 'Continuez tout droit sur {street}',
    'itinerary-summary-row.steps.direction.UTURN_LEFT':
      'Tournez vers {street}',
    'itinerary-summary-row.steps.direction.UTURN_RIGHT':
      'Tournez vers {street}',
    'itinerary-summary-row.steps.direction.CIRCLE_COUNTERCLOCKWISE':
      'Entrez dans le rond-point et prenez la sortie {exit} vers {street}',
    'itinerary-summary-row.steps.direction.CIRCLE_CLOCKWISE':
      'Entrez dans le rond-point à gauche et prenez la sortie {exit} dans le sens des aiguilles d\'une montre pour rejoindre {street}.',
    'itinerary-summary-row.steps.direction.ELEVATOR': 'Prenez l\'ascenseur jusqu\'à {street}',
    'itinerary-summary-row.steps.direction.ENTER_STATION': 'Entrez dans la gare à {street}',
    'itinerary-summary-row.steps.direction.EXIT_STATION': 'Sortez de la gare en direction de {street}',
    'itinerary-summary-row.steps.direction.FOLLOW_SIGNS': 'Suivez les panneaux indiquant {street}',
    'itinerary-summary-row.steps.direction.NORTH': 'vers le nord',
    'itinerary-summary-row.steps.direction.NORTHEAST': 'en direction du nord-est',
    'itinerary-summary-row.steps.direction.EAST': 'vers l\'est',
    'itinerary-summary-row.steps.direction.SOUTHEAST': 'en direction du sud-est',
    'itinerary-summary-row.steps.direction.SOUTH': 'vers le sud',
    'itinerary-summary-row.steps.direction.SOUTHWEST': 'en direction du sud-ouest',
    'itinerary-summary-row.steps.direction.WEST': 'vers le west',
    'itinerary-summary-row.steps.direction.NORTHWEST': 'en direction du nord-ouest',
    "itinerary-summary-row.clickable-area-description": "Afficher sur la carte", 
    "itinerary-summary-row.description": "Itinéraire partant à {departureDate} {departureTime} et arrivant à {arrivalDate} {arrivalTime}. {firstDeparture} {transfers} Temps total {totalTime}.", 
    "itinerary-summary-row.first-departure": "{vehicle} part à {departureTime} de l'arrêt {stopName}.", 
    "itinerary-summary-row.first-leg-start-time": "Congés à {firstDepartureTime} {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform}", 
    "itinerary-summary-row.first-leg-start-time-citybike": "Départ à {firstDepartureTime} de la station de vélo {firstDepartureStop}", 
    "itinerary-summary-row.no-transit-legs": "Partez quand ça vous convient", 
    "itinerary-summary-row.transfers": "Transfert vers {vehicle} à l'arrêt {stopName}", 
    "itinerary-summary-row.walking-distance": "Distance totale de marche {totalDistance}.", 
    "itinerary-summary.bikeAndPublic-fallback-title": "Prenez votre vélo avec vous à bord", 
    "itinerary-summary.bikeAndPublic-rail-subway-title": "Prenez votre vélo avec vous en train ou en métro", 
    "itinerary-summary.bikeAndPublic-rail-title": "Prenez votre vélo avec vous dans le train", 
    "itinerary-summary.bikeAndPublic-subway-title": "Prenez votre vélo au métro", 
    "itinerary-summary.bikePark-title": "Laissez votre vélo à un Park & Ride", 
    "itinerary-summary.interline-wait": "Le numéro de route ({shortName}) et la destination ({destination}) changeront à l'arrêt {stop}. Le temps d'attente au stop est {time}. Attendez à bord.", 
    "itinerary-summary.interline-wait-multiple-legs": "Le numéro d'itinéraire ({shortName}) et la destination changeront plusieurs fois pendant le trajet. Le temps total d'attente est {time}. Veuillez ne pas quitter le véhicule.", 
    "itinerary-summary.show-on-map": "Afficher sur la carte {target}", 
    "itinerary-ticket.title": "Billet requis", 
    "itinerary-tickets.title": "Billets requis", 
    "itinerary-time.title": "Duréé", 
    "itinerary-walk.title": "Distance totale de marche", 
    "journeyplanner.title": "Digitransit for Paris", 
    "language-selection": "Langue: {language}", 
    "last-updated": "Dernière mise à jour {time}", 
    later: "Plus tard", 
    "layer-dropdown-close-label": "Fermer les options de calque de carte", 
    "layer-dropdown-open-label": "Ouvrir les options de calque de carte", 
    "leave-your-car-park-and-ride": "Laissez votre voiture sur le site de Park & Ride", 
    leaves: "Départ", 
    "leaving-at": "Départ à", 
    lighting: "Éclairage", 
    ...
    localadmin: "Localité", 
    locate: "Localiser", 
    "location-examples": "p. ex. Gare de Lyon, Longjumeau, Rue du Bac, Châtelet,...", 
    "location-from-map": "Emplacement sélectionné", 
    "location-from-map-confirm": "Confirmer la sélection", 
    "location-home": "À la maison", 
    "location-school": "École", 
    "location-shopping": "Shopping", 
    "location-sport": "Sports", 
    "location-work": "Travail", 
    login: "Se connecter", 
    "login-content": "Pour enregistrer et utiliser des lieux, des itinéraires et des arrêts, vous devez vous connecter en utilisant votre compte HSL.", 
    "login-header": "Ouvrir une session", 
    logout: "Déconnecter", 
    "long-transfers-margin": "12 min", 
    "main-menu-label-close": "Fermer le menu principal", 
    "main-menu-label-open": "Ouvrir le menu principal", 
    "main-mode": "Voyager avec", 
    map: "Carte", 
    "map-layer-bike-parks": "Places de stationnement pour vélos", 
    "map-layer-category-bicycle-car": "Vélo & Voiture",
    "map-layer-category-public-transit": "Transports publics", 
    "map-layer-category-sharing": "Partage",
    'map-layer-category-leisure-tourism': 'Loisirs et tourisme',
    'map-layer-category-shopping-services': 'Shopping et services',
    'map-layer-category-public-facilities': 'Équipements publics',
    'map-layer-category-health-social-services': 'Santé et services sociaux',
    "map-layer-charging-stations": "Stations de recharge", 
    "map-layer-citybike": "Stations de VTT", 
    "map-layer-dynamic-parking-lots": "Places de stationnement", 
    "map-layer-park-and-ride": "Sites Park & Ride", 
    "map-layer-roadworks": "Travaux routiers", 
    "map-layer-sharing": "Voiture, vélo & Cargo vélo partage", 
    "map-layer-sharing-biycle": "Vélo partage", 
    "map-layer-sharing-car": "Voiture partage", 
    "map-layer-sharing-cargo_bicycle": "Cargo vélo partage", 
    "map-layer-sharing-scooter": "Trotinette partage", 
    "map-layer-stop-bus": "Stations de bus", 
    "map-layer-stop-ferry": "Ferries", 
    "map-layer-stop-funicular": "Funiculaires", 
    "map-layer-stop-tram": "Stations de tram", 
    "map-layer-terminal-bus": "Gares routières", 
    "map-layer-terminal-rail": "Gares", 
    "map-layer-terminal-subway": "Stations de métro", 
    "map-layer-vehicles": "Véhicules", 
    "map-type": "types de cartes", 
    "map-type-bicycle": "vélo", 
    "map-type-openstreetmap": "OSM", 
    "map-type-satellite": "satellite", 
    "map-type-streets": "routes", 
    "menu-faq": "FAQ", 
    "menu-feedback": "Donner votre avis", 
    "menu-link-to-privacy-policy": "Confidentialité", 
    "messagebar-label-close-message-bar": "Fermer le message", 
    "messagebar-label-page": "Page", 
    "minute-short": "min", 
    minutes: "min", 
    "minutes-or-route": "Min / Ligne", 
    "missing-price-info-disclaimer": "Aucune information sur les prix", 
    "modes.to-bike": "vers la station de vélo de ville", 
    "modes.to-bike-park": "vers le parking de vélos", 
    "modes.to-bus": "vers la station de bus", 
    "modes.to-car-park": "vers le parking", 
    "modes.to-place": "vers la destination", 
    "modes.to-rail": "vers la gare", 
    "modes.to-stop": "vers la station", 
    "modes.to-subway": "vers la station de métro", 
    "modes.to-tram": "vers la station de tram", 
    "more-departures": "Autres départs", 
    "more-settings": "Plus de paramètres", 
    "move-on-map": "Déplacer sur la carte", 
    "move-to-tab": "Aller à l'onglet {number}", 
    navigate: "Naviguer", 
    nearest: "{ mode } le plus proche", 
    "nearest-favorites": "Station à côté de moi", 
    "nearest-favorites-browse-stops": "Parcourir et sélectionnez les stations", 
    "nearest-favorites-no-favorites": "Horaires des stations et véhicules sélectionnés sur la carte", 
    "nearest-no-stops": "Il n'y a pas d'arrêts ou de stations pour le mode de transport sélectionné à proximité.", 
    "nearest-stops": "Les stations les plus proches", 
    "nearest-stops-airplane": "aéroports", 
    "nearest-stops-bus": "arrêts de bus", 
    "nearest-stops-carpool": "covoiturage", 
    "nearest-stops-citybike": "station de location de vélos la plus proche", 
    "nearest-stops-favorite": "s'arrête près de moi", 
    "nearest-stops-ferry": "quais de ferry le plus proche", 
    "nearest-stops-rail": "gares la plus proche", 
    "nearest-stops-subway": "stations de métro la plus proche", 
    "nearest-stops-tram": "stations de tram la plus proche", 
    "nearest-stops-update-location": "Mettre à jour {mode}", 
    "nearest-stops-updated-location": "L'emplacement sur la carte a changé", 
    ...
    "no-bike-allowed-popup-tram-bus": "Les vélos ne sont pas autorisés dans les bus ou les trams. Si vous utilisez ces véhicules sur votre trajet, laissez le vélo à l'arrêt ou à un Parc Relais.", 
    "no-departures": "Pas de départ", 
    "no-position": "Aucune position", 
    "no-position-no-stops": "Localisation inconnue, impossible de proposer les arrêts à proximité.", 
    "no-route-already-at-destination": "Vous êtes déjà arrivé à votre destination", 
    "no-route-end": "Veuillez sélectionner la destination", 
    "no-route-end-date-not-in-range": "L'horaire actuel ne contient pas de départs ultérieurs.", 
    "no-route-found": "Malheureusement, l'itinéraire {shortName} ({longName}) n'a pas pu être trouvé.", 
    "no-route-msg": "Impossible de trouver un itinéraire dans cette zone. Changer le point de départ ou d'arrivée", 
    "no-route-msg-time-threshold": "Malheureusement, aucune suggestion d'itinéraire n'a été trouvée. Il est possible qu'aucun horaire ne soit encore disponible pour le jour que vous avez choisi. S'il vous plaît essayez encore plus près de l'heure de votre voyage", 
    "no-route-msg-with-changes": "Malheureusement, aucune option de voyage n'a été trouvée pour votre demande. Veuillez ajuster vos paramètres, votre point de départ ou votre destination.", 
    "no-route-origin-near-destination": "L'origine et la destination sont proches l'une de l'autre. Veuillez modifier l'un des deux emplacements.", 
    "no-route-origin-same-as-destination": "Aucune suggestion d'itinéraire n'a été trouvée parce que l'origine et la destination sont les mêmes.", 
    "no-route-showing-alternative-options": "Aucune suggestion d'itinéraire n'a été trouvée avec vos paramètres. Cependant, nous avons trouvé les options d'itinéraire suivantes:", 
    "no-route-start": "Veuillez choisir le point de départ", 
    "no-route-start-date-too-early": "L'horaire actuel ne contient pas de départs antérieurs.", 
    "no-route-start-end": "Choisir un point de départ et une destination", 
    "no-transfers-margin": "Aucune", 
    "no-trips-found": "Il n'y a pas de trajet possible au jour choisi ({selectedDate}).", 
    "notification-minimize": "Fermer le message", 
    "notification-open": "Ouvrir le message", 
    now: "Maintenant", 
    ...
    "occupancy-status-EMPTY": "vide", 
    "occupancy-status-FEW_SEATS_AVAILABLE": "moyenne occupation", 
    "occupancy-status-MANY_SEATS_AVAILABLE": "faible taux d'occupation", 
    "occupancy-status-STANDING_ROOM_ONLY": "forte occupation", 
    "off-canvas-info": "En vous connectant, vos favoris seront sauvegardés et accessibles depuis d'autres appareils", 
    "on-demand-taxi-itinerary": "Seules les routes impliquant des taxis à la demande ont été trouvées.", 
    "only-public-transport-disclaimer": "Prix valable uniquement pour les transports en commun.", 
    open: "Ouvert", 
    ...
    or: "ou", 
    origin: "Départ", 
    "origin-and-destination": "Départ et arrivée", 
    "origin-defined": "Lieu de départ défini", 
    ...
    "origin-placeholder": "Départ (adresse ou arrêt)", 
    "other-dates": "Autres dates", 
    "own-position": "Position actuelle", 
    "page-not-found": "Page non trouvée", 
    paid: "Payés", 
    "park-and-ride": "Park & Ride", 
    "park-and-ride-availability": "Places disponible", 
    "parking-spaces-available": "{free} de {total} places de stationnement disponibles", 
    "parking-spaces-in-total": "{total} places de stationnement", 
    "pay-attention": "Attention !", 
    payment_at_gate: "Paiement à la porte", 
    "pick-icon": "Sélectionner une icône", 
    "pick-mode": "Sélectionner un mode de transport", 
    "pick-mode-airplane-disabled": "Vol non sélectionné", 
    "pick-mode-airplane-enabled": "Vol sélectionné", 
    "pick-mode-bus-disabled": "Bus non sélectionné", 
    "pick-mode-bus-enabled": "Bus sélectionné", 
    "pick-mode-citybike-disabled": "Vélo de ville non sélectionné", 
    "pick-mode-citybike-enabled": "Vélo de ville sélectionnée", 
    "pick-mode-ferry-disabled": "Ferry non sélectionné", 
    "pick-mode-ferry-enabled": "Ferry sélectionné", 
    "pick-mode-rail-disabled": "Train non sélectionné", 
    "pick-mode-rail-enabled": "Train sélectionné", 
    "pick-mode-selected": "Modes de transport choisis", 
    "pick-mode-subway-disabled": "Métro non sélectionné", 
    "pick-mode-subway-enabled": "Métro sélectionné", 
    "pick-mode-tram-disabled": "Tram non sélectionné", 
    "pick-mode-tram-enabled": "Tram sélectionné", 
    "pick-street-mode": "Mes modes de transport", 
    ...
    position: "Position", 
    "position-disclaimer": "La position est estimée. Dernier emplacement connu à {time}.", 
    "position-estimated": "Position estimée. Aucune information sur la position actuelle n'est disponible.", 
    precipitation: "Précipitation", 
    "precipitation-hail": "grêle", 
    "precipitation-icy-rain": "manches", 
    "precipitation-none": "aucune", 
    "precipitation-rain": "pluie", 
    "precipitation-sleet": "manches", 
    "precipitation-snow": "neige", 
    "precipitation-unknown": "inconnu", 
    ...
    "rent-bicycle-at": "Décrocher un vélo à la station {station}", 
    "rent-car-at": "Louer une voiture à la station {station}", 
    "rent-scooter-at": "Louer un trottinette à la station {station}", 
    "report-defect": "Défaut signalé", 
    "required-ticket": "Billet de transport requis", 
    "return-bicycle-to": "Rendre le vélo:", 
    "return-scooter-to": "Rendre la trottinette électrique à la station {station}", 
    "right-now": "Immédiatement", 
    "road-condition-dry": "sec", 
    "road-condition-frosty": "gelée", 
    "road-condition-icy": "glace", 
    "road-condition-moist": "humide", 
    "road-condition-moist-salty": "humide/salé", 
    "road-condition-snowy": "neige", 
    "road-condition-unknown": "inconnu", 
    "road-condition-wet": "humide", 
    "road-condition-wet-salty": "humide/sel", 
    "road-temperature": "Température des routes", 
    "road-weather": "météo routière", 
    route: "Ligne ", 
    "route-add-viapoint": "Via point", 
    "route-custom-settings": "Paramètres personnalisés", 
    ...
    "route-least-elevation-changes": "Éviter les changements d'altitude", 
    ...
    "route-page-vehicle-position": "{mode} {shortName} is at {stopName}", 
    "route-page-vehicle-position-between": "{mode} {shortName} is between {stopName} and {nextStopName}", 
    "route-page-vehicle-selected": "Sélection actuelle.", 
    "route-page.description": "Ligne {shortName}, {longName}", 
    "route-page.future-routes": "Connexions futures", 
    "route-page.pattern-chosen": "Sélectionné", 
    "route-page.pattern-select-title": "Sélectionnez l'itinéraire à consulter", 
    "route-page.similar-routes": "Vous pourriez aussi être intéressé par", 
    "route-page.special-routes": "Autres routes", 
    "route-page.title": "Ligne {shortName}", 
    "route-page.title-short": "Ligne ", 
    "route-to-ferry": "Route vers la jetée", 
    "route-to-park": "Route vers le parking", 
    "route-to-station": "Route vers la station", 
    "route-to-stop": "Route vers l'arrêt", 
    "router-change-departure-time": "Changer l'heure de départ ›", 
    "router-location-not-found": "Veuillez sélectionner l'emplacement sur le réseau routier ou à un arrêt.", 
    "router-location-not-found-title-1": "Il n'y a aucun accès défini à la destination", 
    "router-location-not-found-title-2": "Il n'y a pas d'accès défini à l'origine", 
    "router-location-not-found-title-3": "Il n'y a pas d'accès défini à l'origine et à la destination", 
    "router-only-walk": "Pas d'alternatives plus rapides que la marche sont disponibles pour l'itinéraire que vous recherchez.", 
    "router-only-walk-title": "Marcher la route", 
    "router-outside-bounds-3": "Aucune suggestion de route n'a été trouvée parce que l'origine et la destination sont à l'extérieur de la zone de service.", 
    "router-outside-service-period": "Les informations sur les horaires ne sont pas disponibles pour le temps que vous avez sélectionné.", 
    "router-stops-in-range-1": "Il n'y a pas d'arrêts de transports publics suffisamment proches de la destination choisie.", 
    "router-stops-in-range-2": "Il n'y a pas d'arrêt de transport public suffisamment proche de l'origine choisie.", 
    "router-stops-in-range-3": "Il n'y a pas d'arrêt de transport public suffisamment proche de l'origine et de la destination sélectionnées.", 
    "router-system-error": "Une erreur s'est produite dans le système. Veuillez réessayer plus tard.", 
    "router-transit-connection": "Veuillez essayer de changer l'origine ou la destination.", 
    "router-transit-connection-in-search-window": "Aucun service n'est disponible au moment choisi.", 
    "router-unable": "Impossible de montrer les options d'itinéraire", 
    routes: "Lignes", 
    "routes-platforms": "Routes et plateformes", 
    "routes-tracks": "Routes et pistes", 
    run: "Lancer", 
    save: "Enregistrer", 
    "scooter-availability": "{amount} Scooters disponibles à la station en ce moment", 
    "scooter-distance-duration": "Roulez votre scooter {duration} ({distance})", 
    "scooter-register-required": "Pour utiliser des scooters, vous devez vous enregistrer", 
    "scooter-start-using": "Réservez un e-scooter", 
    "scooter-start-using-info": "Plus d'informations à", 
    "scooter-station-no-id": "e-scooter", 
    "scooterwalk-distance-duration": "Marchez votre scooter {duration} ({distance})", 
    search: "Recherche", 
    "search-autosuggest-label": "Lieu, endroit et recherche d'arrêt.", 
    ...
    "search-fields.sr-instructions": "La recherche d'itinéraires aura lieu automatiquement lorsque vous entrez l'origine et la destination. Changer les paramètres de recherche déclenchera une nouvelle recherche. Naviguez dans les champs de recherche en utilisant la touche onglet", 
    ...
    "search-search-results-but-no-destination": "Voir les résultats de l'onglet 'Ligne ou arrêt'", 
    "searching-position": "Positionnement en cours...", 
    "select-all-routes": "Sélectionner toutes les routes", 
    "select-date": "Sélectionner la date", 
    "select-from-map-destination": "Sélectionner une destination", 
    "select-from-map-favourite": "Sélectionner dans la carte", 
    "select-from-map-no-title": "Pas de titre", 
    "select-from-map-origin": "Sélectionner l'origine", 
    "select-from-map-viaPoint": "Sélectionner viapoint", 
    "select-map-layers-header": "Qu'afficher sur la carte ?", 
    "select-position": "Utiliser une localisation précédente", 
    "select-route": "Sélectionnez {mode} route {shortName} vers {headsign}", 
    "selected-routes": "Lignes sélectionnées", 
    send: "Envoyer", 
    "separate-ticket-required": "Un billet séparé est requis pour cette partie de l'itinéraire.", 
    "separate-ticket-required-disclaimer": "Cet itinéraire contient une ou plusieurs jambes pour lesquelles {agencyName} ne vend pas de billets.", 
    "set-specific-settings": "Définir des paramètres plus spécifiques", 
    "set-stop-as-routes": "Réglez l'arrêt comme itinéraire", 
    "set-time-earlier-button-label": "Régler le temps de voyage à plus tôt", 
    "set-time-later-button-label": "Réglez le temps de voyage à plus tard", 
    "set-time-now-button-label": "Régler le temps de voyage à l'heure actuelle", 
    settings: "Réglages", 
    "settings-alternative-name-rail": "Train", 
    "settings-change-itinerary-settings": "Modifier les paramètres", 
    "settings-dropdown-close-label": "Fermer les options", 
    "settings-dropdown-open-label": "Ouvrir les options", 
    "settings-label-change": "Changer les paramètres", 
    "settings-missing-itineraries-body": "Certaines sélections dans les paramètres excluent certaines alternatives de route.", 
    "settings-missing-itineraries-header": "Y a-t-il des solutions de remplacement?", 
    share: "Partager la route", 
    show: "Afficher", 
    "show-departures": "Afficher les départs", 
    "show-more": "Afficher plus", 
    "show-more-stops-near-you": "Afficher plus d'arrêts près de chez vous", 
    "show-routes": "Afficher les lignes", 
    "skip-positioning": "Ignorer", 
    "skip-to-content": "Skip to content", 
    slow: "Lent", 
    "specify-location": "Indiquer un endroit", 
    "splash-locating": "Positionnement...", 
    ...
    station: "Station", 
    stop: "Arrêt", 
    "stop-departure-time-future": "Heure de départ en {minutes} minutes", 
    "stop-departure-time-past": "L'heure de départ était", 
    "stop-list-update.sr-instructions": "Les heures de départ pour chaque arrêt seront mises à jour en temps réel.", 
    "stop-near-you": "Arrêts de recherche et itinéraires", 
    "stop-near-you-modal-grant-permission": "ou de permettre des services de localisation", 
    "stop-near-you-modal-grant-permission-info": "Vous pouvez activer les services de localisation dans les paramètres de votre téléphone ou de votre navigateur, ce qui permet au service d'utiliser votre emplacement actuel.", 
    "stop-near-you-modal-header": "Vous n'avez pas activé les services de localisation", 
    "stop-near-you-modal-info": "L'utilisation de la fonction d'arrêt à proximité nécessite un accès à l'emplacement.", 
    "stop-near-you-title": "Rechercher des arrêts et des itinéraires", 
    "stop-near-you-update-alert": "Arrêts les plus proches mis à jour", 
    "stop-number": "Identifiant d'arrêt", 
    "stop-page.description": "Arrêt - {name} {code}, {desc}", 
    "stop-page.right-now.loaded": "page d'arrêt chargée", 
    "stop-page.title": "Arrêt - {name} {code}", 
    "stop-page.title-short": "Arrêt", 
    "stop-virtual-monitor": "Arrêter l'affichage", 
    stops: "Arrêts", 
    "stops-near-you.description": "Stop timetables and vehicles near your", 
    "stops-near-you.title": "Near by stops timetables", 
    street: "Route", 
    "street-mode-bicycle": "Vélo", 
    "street-mode-bike-aria": "Montrez la route cyclable. Durée {duration}, distance {length}", 
    "street-mode-bikeandvehicle-aria": "Montrer une combinaison de vélo et de transports en commun. Durée {duration}, distance {length}", 
    "street-mode-car": "Voiture", 
    "street-mode-car-aria": "Voiture", 
    "street-mode-car_park": "Park & Ride", 
    "street-mode-ondemandtaxi-aria": "Voir sur demande. Durée {duration}, distance {length}", 
    "street-mode-parkandride-aria": "Montrer parc et itinéraire. Durée {duration}, distance de conduite {length}", 
    "street-mode-public_transport": "Transport public", 
    "street-mode-scooter": "Scooter", 
    "street-mode-scooter-aria": "Montrer scooter ou scooter avec route de transit. Durée {duration}, distance {length}", 
    "street-mode-walk": "Marche", 
    "street-mode-walk-aria": "Afficher l'itinéraire à pied. Durée {duration}, distance {length}.", 
    subway: "Métro", 
    "subway-with-route-number": "Afficher l'itinéraire en Métro {routeNumber} {headSign}", 
    "summary-page.description": "{from} - {to}", 
    "summary-page.row-label": "Proposition d'itinéraire {number}", 
    "summary-page.title": "Itinéraire proposé", 
    surveillance_cameras: "Surveillance des caméras", 
    "swap-order-button-label": "Origine et destination inversées", 
    swedish: "Suédois", 
    "swipe-disruption-info": "Disruption info balayez les onglets des résultats", 
    "swipe-disruption-info-header": "Disruption info balayez les onglets de résultats.", 
    "swipe-message-bar": "Message glisser les onglets de résultat", 
    "swipe-message-bar-header": "Message balayez les onglets de résultats.", 
    "swipe-result-tab-left": "Appuyez sur Entrée ou Espace pour afficher l'onglet précédent.", 
    "swipe-result-tab-right": "Appuyez sur Entrée ou Espace pour afficher l'onglet suivant.", 
    "swipe-result-tabs": "Changer les onglets en utilisant les touches fléchées.", 
    "swipe-sr-new-tab-opened": "Onglet {number} ouvert.", 
    "swipe-stops-near-you": "Arrêtez près de vous balayez les onglets de résultats.", 
    "swipe-stops-near-you-header": "Arrête près de vous balayez les onglets de résultats", 
    "swipe-summary-page": "Tabulations de résultats de balayage des itinéraires", 
    "swipe-summary-page-header": "Des onglets de résultats de balayage.", 
    "taxi-availability": "Taxis disponibles à la station dès maintenant", 
    "taxi-station-no-id": "Classe de taxi", 
    "terminal-page.description": "Terminal - {name}", 
    "terminal-page.title": "Terminal - {name}", 
    "terminal-page.title-short": "Terminal", 
    "terms-of-use": "Conditions d'utilisation", 
    "ticket-and-price-info": "Billets et informations tarifaires", 
    "ticket-single-adult": "Adulte", 
    "ticket-type-none": "Pas de limite tarifaire", 
    tickets: "Titres de transport", 
    time: "Heure", 
    "time-navigation-buttons": "Boutons de navigation dans le temps", 
    "time-selector-form": "Modifier l'heure", 
    "time-selector-hours-label": "Heure", 
    "time-selector-minutes-label": "Minute", 
    timetable: "Fiche horaire", 
    "to-frontpage": "Retour à la page d'accueil", 
    "to-rail": "train", 
    "to-subway": "métro", 
    today: "Aujourd'hui", 
    tomorrow: "Demain", 
    track: "Voie", 
    "track-num": "Voie {platformCode}", 
    "track-short": "Voie {platformCode}", 
    "track-short-no-num": "Voie", 
    tram: "Tramway", 
    ...
    "travel-time": "{min} min", 
    "travel-time-label": "Durée du voyage", 
    "travel-time-with-hours": "{h} h {min} min", 
    ...
    "use-national-service-postfix": ".", 
    "use-national-service-prefix": "Nous vous recommandons d'essayer le planificateur de voyage national,", 
    "use-own-position": "Utiliser la position actuelle", 
    userinfo: "Mes informations", 
    usermenu: "Menu utilisateur", 
    "using-modes": "Modes de transport", 
    "vehicle-parking-operator": "Exploitant: {operator}", 
    venue: "Lieu", 
    ...
    vr_ticket: "Billets VR", 
    wait: "Attendre", 
    "wait-amount-of-time": "Attendre {duration}", 
    walk: "marcher", 
    "walk-bike-itinerary-1": "Votre recherche n'a retourné que des itinéraires pédestres.", 
    "walk-bike-itinerary-2": "Votre recherche n'a retourné que des itinéraires cyclistes.", 
    "walk-bike-itinerary-3": "Votre recherche n'a retourné que des itinéraires à pied et à vélo.", 
    "walk-bike-itinerary-4": "Votre recherche n'a retourné que des itinéraires nécessitant du vélo ou de la conduite.", 
    "walk-distance-duration": "Marcher {duration} ({distance})", 
    "walk-only": "Marcher seulement", 
    walking: "Marcher", 
    ...
    "weather-data-source": "Source: Institut météorologique finlandais", 
    "weather-detail-title": "Prévisions météorologiques du lieu d'origine à", 
    "weather-icon-1": "Effacer", 
    "weather-icon-2": "En partie nuageux", 
    "weather-icon-21": "Douches légères", 
    "weather-icon-22": "Douches", 
    "weather-icon-23": "Douches lourdes", 
    "weather-icon-3": "Couverture", 
    "weather-icon-31": "Pluie légère", 
    "weather-icon-32": "Pluie", 
    "weather-icon-33": "Fortes pluies", 
    "weather-icon-41": "Averses de neige légères", 
    "weather-icon-42": "Averses de neige", 
    "weather-icon-43": "De fortes averses de neige", 
    "weather-icon-51": "Faible chute de neige", 
    "weather-icon-52": "Chutes de neige", 
    "weather-icon-53": "Fortes chutes de neige", 
    "weather-icon-61": "Orage intense", 
    "weather-icon-62": "Des tonnerres intense", 
    "weather-icon-63": "Orage", 
    "weather-icon-64": "Orage intense", 
    "weather-icon-71": "Douches à manches légères", 
    "weather-icon-72": "Douches à manches", 
    "weather-icon-73": "Douches lourdes à manches", 
    "weather-icon-81": "Manche légère", 
    "weather-icon-82": "Manchette", 
    "weather-icon-83": "Manches intense", 
    "weather-icon-91": "Brouillard", 
    "weather-icon-92": "Brouillard", 
    "weekday-fr": "Vendredi", 
    "weekday-mo": "Lundi", 
    "weekday-ph": "Jour férié", 
    "weekday-sa": "Samedi", 
    "weekday-su": "Dimanche", 
    "weekday-th": "Jeudi", 
    "weekday-tu": "Mardi", 
  ...
  nb: {
    ...
    'bicycle-availability': '{amount} vSykler finnes',
    'bike-station-disabled': 'Pyöräasema ei ole käytössä.',
    bus: 'Buss',
    ...
    'bicycle-distance-duration': 'Sykle {duration} ({distance})',
    'bicyclewalk-distance-duration': 'Trill sykkelen {duration} ({distance})',
    datasources: 'Datakilder',
    datasource: 'Datakilde',
    delete: 'Slett',
    'departure-time-in-minutes': '{minutes} m',
    ...
    'rent-bicycle-at': 'Lei sykkel fra stativ {station}',
  ...
  ro: {
    ...
    'bicycle-availability': '{amount} Biciclete disponibile la destinație',
    ...
    'bicycle-distance-duration': 'Pedalați {duration} ({distance})',
    'bicyclewalk-distance-duration':
    ...
    'rent-bicycle-at': 'Închiriați o bicicletă la stația {station}',
    'rent-scooter-at': 'Închiriați o trotinetă electrică la stația {station}',
    'required-ticket': 'Bilet necear pentru călătorie',
    'return-bicycle-to': 'Returnați bicicleta la stația {station}',
    ...
    run: 'Rulează',
    save: 'Salvare',
    'scooter-availability': '{amount} Trotinete disponibile în stație',
  ...
  sv: {
    ...
    'bicycle-availability': '{amount} Antal cyklar just nu',
    ...
    'bicycle-start-using': 'Ta stadscyklar i bruk',
    'bicycle-start-using-info': 'Tilläggsinformation',
    'citybike-station': 'Stadscykelstation {stationId}',
    'bicycle-station-no-id': 'Stadscykelstation',
    ...
    'bicycle-distance-duration': 'Cykla {duration} ({distance})',
    'bicyclewalk-distance-duration': 'Led cykeln {duration} ({distance})',
    // eslint-disable-next-line sort-keys
    ...
    run: 'Springande',
    save: 'Spara',
    'scooter-availability': '{amount} Antal sparkcyklar just nu',
 ...
 pl: {
    ...
    "bicycle-availability": "{amount} Dostępne rowery", 
    privacy: "Prywatność", 
    "bicycle-station-no-id": "Stacja rowerowa", 
    ...
    "map-layer-category-bicycle-car": "Rower & Samochód", 
    ...
    "bicycle-start-using": "Zacznij korzystać z wypożyczonych rowerów", 
    "bicycle-start-using-info": "Więcej informacji na stronie", 
    ...
    "bicycle-distance-duration": "{duration} rowerowe ({distance})", 
    "bicyclewalk-distance-duration": "Chodzenie po {duration} rowerowym ({distance})", 
    ...
    run: "Uruchom", 
    save: "Zapisz", 
    "scooter-availability": "{amount} Kick scootery dostępne na stacji już teraz", 
  ...
  nl: {
    "accessibility-routing-disabled": "Door een gebrek aan gegevens over toegankelijkheid kunnen we op dit moment geen informatie geven over toegankelijke routes.", 
    "bicycle-parking-filter": "Parkeermogelijkheden voor fietsen", 
    "bicycle-parking-filter-all": "Alle parkeerplaatsen", 
    "bicycle-parking-filter-freeOnly": "Alleen gratis", 
    "bicycle-parking-filter-securePreferred": "Veilig voorkeur", 
    "bicycle-parking-shed": "Fietsenstalling", 
    "bicycle-parking-lockers": "Fietskasten", 
    "bicycle-parking-garage": "Fietsparkeergarage", 
    "scooter-start-using": "Boek een e-scooter", 
    "scooter-start-using-info": "Meer informatie op", 
    "scooter-station-no-id": "e-scooter", 
    "book-locker": "Boekruimte", 
    "fares-disclaimer": "De tariefinformatie wordt verstrekt door de Nahverkehrsgesellschaft Baden-Württemberg mbH (NVBW). Alle informatie zonder garantie.", 
    imprint: "Impressum", 
    "position-estimated": "Positie geschat. Geen actuele positieinformatie beschikbaar.", 
    "position-disclaimer": "Positie is geschat. Laatst bekende positie op {time}.", 
    direction: "Aan", 
    "car-start-using": "Reserveer een autodeelauto", 
    "car-start-using-info": "Meer informatie op", 
    "car-station-no-id": "Station voor autodelen",
    "car-availability": "{amount} Gedeelde auto's beschikbaar", 
    cargo_bicycle: "Bakfiets ", 
    "cargo_bicycle-booking-link": "Boek", 
    "cargo_bicycle-content-description": "Vrachtfietsstation", 
    "cargo_bicycle-start-using": "Boek een cargo fiets", 
    "cargo_bicycle-start-using-info": "Meer informatie op", 
    "cargo_bicycle-station-no-id": "Cargo fietsstation", 
    "cargo_bicycle-capacity-no-data": "Geen capaciteitsgegevens beschikbaar", 
    ...
    "bicycle-availability": "{amount} Fietsen beschikbaar",
    privacy: "Privacy", 
    "bicycle-station-no-id": "Fietsstation", 
    "taxi-station-no-id": "Taxistandplaats", 
    "car-sharing-station-no-id": "Autodeelstation", 
    "report-defect": "defecten melden.", 
    "map-layer-roadworks": "Bouwplaatsen", 
    "weekday-mo": "Maandag", 
    "weekday-tu": "Dinsdag", 
    "weekday-we": "Woensdag", 
    "weekday-th": "Donderdag", 
    "weekday-fr": "Vrijdag", 
    "weekday-sa": "Zaterdag", 
    "weekday-su": "Zondag", 
    "weekday-ph": "Feestdag", 
    "opening-hours": "Openingstijden", 
    "parking-spaces-in-total": "{total} parkeerplaatsen", 
    "parking-spaces-available": "{free} van {total} parkeerplaatsen beschikbaar", 
    open: "Open", 
    closed: "Gesloten", 
    "map-layer-sharing": "Autodelen & fiets- / bakfietsverhuur", 
    "map-layer-category-public-transit": "Openbaar vervoer (OV)", 
    "map-layer-category-bicycle-car": "Fiets & Auto",
    "map-layer-category-sharing": "Delen",
    'map-layer-category-leisure-tourism': 'Vrije tijd & Toerisme',
    'map-layer-category-shopping-services': 'Winkelen & Diensten',
    'map-layer-category-public-facilities': 'Openbare voorzieningen',
    'map-layer-category-health-social-services': 'Gezondheid & sociale zaken',
    "about-service-feedback": "Over de service en feedback", 
    "about-these-pages": "Over de website", 
    "about-this-service": "Over de dienst", 
    "car-park-capacity-alert": "Er zijn bijna geen vrije parkeerplaatsen meer. Controleer een route op een later tijdstip.", 
    "exclude-full-carparks": "Uitgesloten volledige parkeergarages", 
    "accept-carpool-policy": "Ik heb Fahrgemeinschaft gelezen en accepteer de's <a href=\"{policyUrl}\" target=\"_blanc\" stijl=\"kleur: #92bc05\">privacybeleid</a> en <a href=\"{termsUrl}\" target=\"_blanc\" stijl=\"kleur: #92bc05\">gebruiksvoorwaarden</a>.", 
    access_with: "toegang met", 
    accessibility: "Toegankelijkheid", 
    "accessibility-limited": "Rolstoeltoegankelijk", 
    "accessibility-nolimit": "Geen beperkingen", 
    "accessibility-statement": "Toegankelijkheidsverklaring", 
    "map-type": "kaarttypes", 
    "map-type-streets": "Straaten ", 
    "map-type-satellite": "satelliet", 
    "map-type-bicycle": "fiets", 
    "map-type-openstreetmap": "OSM", 
    "cycling-map-legend-title": "kaart legende", 
    "cycling-map-legend-bike-parking": "Fietsenparkeerplaats", 
    "cycling-map-legend-bike-parking-covered": "overdekte fietsenstalling", 
    "cycling-map-legend-bike-parking-lockable": "afsluitbare fietsenstalling", 
    "cycling-map-legend-bike-repair": "reparatie van fietsen", 
    "cycling-map-legend-bike-lane": "fietspad", 
    "cycling-map-legend-major-cycling-route": "belangrijkste fietsroute", 
    "cycling-map-legend-local-cycling-route": "lokale fietsroute", 
    "add-favourite-bikeStation-failed-heading": "Opslaan van het leenstation mislukt", 
    "add-favourite-place-failed-heading": "Locatie kan niet worden opgeslagen", 
    "add-favourite-route-failed-heading": "Opslaan van de route mislukt", 
    "add-favourite-station-failed-heading": "Opslaan van de station mislukt", 
    "add-favourite-stop-failed-heading": "Opslaan van de halte is mislukt", 
    "add-home": "Thuis instellen", 
    "add-itinerary-via-point": "Tussenstop toevoegen", 
    "add-location-to-favourites": "Favoriete plaatsen opslaan", 
    ...
    "add-via-duration-button-label-close": "Selecteer de stopduur via punt sluiten {{index}}", 
    "add-via-duration-button-label-open": "Open stop duur selector op via punt {{index}}", 
    "add-work": "Werklocatie instellen", 
    "additional-info": "Informatie verschijnt hier...", 
    "air-temperature": "Luchttemperatuur", 
    "alert:bikerental:free-floating-drop-off": "Bestemming is geen retourstation. Huren kan hier niet worden voltooid. Afhankelijk van de aanbieder kunnen verdere kosten in rekening worden gebracht tot de fiets wordt teruggebracht naar een station.", 
    all: "Alles", 
    "aria-itinerary-summary": "Totale reistijd {duration}. Vertrekkend op {inFuture} {departureTime} en aankomst op {arrivalTime}", 
    "aria-itinerary-summary-bike-distance": "Route per fiets  {duration}, {distance}", 
    "aria-itinerary-summary-car-distance": "Totale reistijd {duration}, {distance}", 
    "aria-itinerary-summary-walk-distance": "Route te voet {duration}, {distance}", 
    "arrive-leave": "Aankomst of vertrek op de geselecteerde tijd", 
    "as-destination": "Bestemming", 
    "as-origin": "Start", 
    "as-viapoint": "Tussenstop  ", 
    "search-autosuggest-label": "Locatie, plaats en halte zoeken.", 
    ...
    "select-from-map-destination": "Selecteer bestemming", 
    "select-from-map-favourite": "Selecteer op de kaart", 
    "select-from-map-no-title": "Geen titel", 
    "select-from-map-origin": "Selecteer vertrekpunt", 
    "select-from-map-viaPoint": "Selecteer tussenstop", 
    "set-time-earlier-button-label": "kies een vroegere reistijd.", 
    "set-time-later-button-label": "Kies een latere reistijd", 
    "set-time-now-button-label": "Reistijd instellen op huidige", 
    "time-navigation-buttons": "Tijdnavigatieknoppen", 
    "time-selector-form": "Tijd bewerken", 
    address: "Adres", 
    "address-or-stop": "Adres of stopplaats", 
    agency: "Exploitant", 
    airplane: "Vlucht", 
    "airplane-with-route-number": "Vlucht {routeNumber}", 
    "airport-check-in": "Check direct in bij aankomst als je niet van tevoren hebt ingecheckt", 
    "airport-collect-luggage": "Verzamel uw bagage", 
    "airport-security-check-go-to-gate": "Ga door de beveiliging naar de vertrekgate.", 
    "all-routes": "Alle routes", 
    "all-routes-disabled": "Geen routes", 
    "approx-meters": "{approxDistance} m", 
    "arriving-at": "Aankomst", 
    "arriving-soon": "Nu", 
    "at-time": "op", 
    "avoid-transfers": "Vermijd overstappen", 
    "avoid-walking": "Vermijd lopen", 
    "back-button-title": "Terug naar de vorige pagina", 
    "back-to-front-page": "Terug naar de vorige pagina", 
    bicycle: "Fiets", 
    "bicycle-charging-station": "Fiets oplaadstation", 
    "bicycle-distance-duration": "Fiets {duration} ({distance})", 
    "bicycle-walk-from-transit": "Haal je fiets van de {transportMode} en loop hem voor {distance} ({duration})", 
    "bicycle-walk-from-transit-no-duration": "Stap met je fiets uit de {transportMode}", 
    "bicycle-walk-to-transit": "Loop met je fiets voor {distance} ({duration}) en neem het op de {transportMode}", 
    "bicycle-walk-to-transit-no-duration": "Duw je fiets naar de {transportMode}", 
    bicycle_frame_lock: "Frameslot", 
    bicycle_walk: "Duw fiets", 
    "bicycle-parking": "Fietsparkeerplaats", 
    "bicycle-parking-covered": "gedekt", 
    "cargo_bicycle-availability": "{amount} bakfietsen beschikbaar", 
    "taxi-availability": "Taxi's nu beschikbaar op het station", 
    "bike-and-ride": "Fietsen & rijden", 
    "bike-not-allowed-bus": "Fietsen zijn niet toegestaan in de bus", 
    "bike-not-allowed-tram": "Fietsen zijn niet toegestaan op de tram", 
    "bike-only": "Alleen fietsen", 
    "bike-park": "Park & Ride voor fietsen", 
    "bike-park-disclaimer": "Je kunt fietsen en openbaar vervoer (OV) gemakkelijk combineren: Parkeer je fiets bij een Park & Ride en vervolg je reis met de trein, bus, metro of tram. Fietsparkeren is gratis en er zijn geen tijdsbeperkingen.", 
    "bike-park-disclaimer-header": "Parkeer uw fiets", 
    "bike-park-disclaimer-link": "Lees meer over Park & Ride voor fietsen", 
    "bike-station-disabled": "Het verhuurstation is buiten gebruik", 
    "biketransport-citybike": "Ik gebruik een citybike", 
    "biketransport-only-bike": "Ik reis alleen per fiets", 
    "biking-amount": "Aandeel van de fietsroute", 
    "biking-speed": "Fietssnelheid", 
    bus: "bus", 
    "bus-express": "Snelbus", 
    "bus-local": "Bus in de buurt", 
    "bus-with-route-number": "Bus {routeNumber} {headSign}", 
    buy: "Kopen", 
    "buy-ticket": "hoe koop ik een ticket", 
    call: "Bel {number}", 
    cancel: "Annuleren", 
    canceled: "Geannuleerd", 
    "canceled-itineraries-amount": "Extra {itineraryAmount, meervoud, =1 {1 annuleerde route} andere {{itineraryAmount} geannuleerde routes}", 
    "canceled-itineraries-amount-hide": "Geannuleerde routes verbergen ({itineraryAmount})", 
    "canceled-legs": "Vertrek op de route geannuleerd", 
    car: "Auto", 
    "car-charging-station": "Autolaadstation", 
    "car-distance-duration": "Rijden {duration} ({distance})", 
    "car-only": "alleen auto", 
    "car-park-full": "Exclusief volle parkeerplaatsen.", 
    "car-park-disclaimer": "Parkeer je auto en reis verder met OV.", 
    "car-park-disclaimer-header": "Parkeer je auto", 
    "car-park-disclaimer-link": "Lees meer over Park & Ride", 
    car_park: "Parkeren & rijden", 
    carpool: "Carpool", 
    "carpool-legal-notice": "Dit is een dienst van de externe provider ride2Go GmbH.", 
    "carpool-distance-duration": "Meerijden {duration} ({distance})", 
    "carpool-only": "Alleen carpoolen", 
    "carpool-with-route-number": "Carpoolroute {routeNumber} naar {headsign}", 
    "card-header-back-to-result-list": "Ga terug naar de resultaten", 
    cause: "oorzaak", 
    "char-left": "tekens", 
    "charging-free": "Opladen is gratis", 
    "charging-not-free": "Opladen tegen een vergoeding", 
    "charging-spaces-available": "{available} van {capacity} oplaadpunten beschikbaar", 
    "charging-spaces-in-total": "{capacity} oplaadpunten", 
    "charging-spaces-no-data": "Geen capaciteitsgegevens beschikbaar", 
    "choose-freely": "Vrije keuze", 
    "choose-stop": "Selecteer stop", 
    "choose-stop-or-vehicle": "Selecteer voertuig of stop", 
    "choose-vehicle": "Selecteer voertuig", 
    citybike: "Cityfiets", 
    "citybike-buy-season": "Koop een dagelijkse, wekelijkse of seizoenkaart", 
    "citybike-distance-duration": "Fiets {duration} ({distance})", 
    "citybike-duration-general-header": "Extra kosten gelden voor verschillende trajecten die door een stadsfiets moeten worden ingevuld.", 
    "citybike-duration-info": "U kunt een stadsfiets tot {duration} minuten per keer rijden, waarna u extra in rekening wordt gebracht.", 
    "citybike-duration-info-header": "Het gedeelte van de route dat door een stadsfiets moet worden ingevuld duurt meer dan {duration} minuten.", 
    "citybike-duration-info-short": "De sectie van de route duurt meer dan {duration} min. Extra kosten zijn van toepassing.", 
    "citybike-network-headers": "Citybikes en scooters.", 
    "citybike-purchase-link": "Kopen", 
    "citybike-register-required": "Registratie voor huurfietsen verplicht", 
    "citybike-return-full": "De huurfiets terugbrengen?", 
    "citybike-return-full-link": "Hoe een fiets terug te brengen wanneer een fietsstation vol is ›", 
    "bicycle-start-using": "Beginnen met stadsfietsen", 
    "bicycle-start-using-info": "Meer informatie", 
    "citybike-station": "Fietsstation {stationId}", 
    "clear-button-label": "Wissen", 
    close: "Sluiten", 
    "close-favourite-module": "De module Favorieten sluiten", 
    "close-settings": "Venster sluiten en instellingen opslaan", 
    "contact-information": "{contactName} contactgegevens", 
    "continue": "Doorgaan", 
    "copy-code": "Code kopiëren", 
    covered: "Overdekt  ", 
    "create-account": "{contactName}-account aanmaken", 
    "create-embedded-search": "Een routezoekelement aanmaken", 
    "create-stop-monitor": "Een stopscherm aanmaken", 
    "bicyclewalk-distance-duration": "Duw je fiets {duration} ({distance})", 
    ...
    day: "Dag", 
    "delete": "Verwijderen", 
    "delete-favourite-failed-heading": "Verwijderen niet mogelijk", 
    "departure-is-canceled": "{modeInfo} {from}–{to} op {time} is geannuleerd", 
    "departure-is-canceled-airplane": "Vlucht {shortName}", 
    "departure-is-canceled-bus": "Bus {shortName}", 
    "departure-is-canceled-ferry": "veerboot{shortName}", 
    "departure-is-canceled-rail": "{shortName} trein", 
    "departure-is-canceled-subway": "Metrodienst {shortName}", 
    "departure-is-canceled-tram": "Tram {shortName}", 
    "departure-list-update.sr-instructions": "De lijst van aankomende vertrek- en vertrektijden wordt in realtime bijgewerkt.", 
    "departure-page-sr": "Trip {shortName} {destination} {time} informatie", 
    "departure-time-in-minutes": "{minutes} min", 
    "departure-time-sr": "{when} uur {time}. {realTime}", 
    departures: "Vertrek", 
    "departures-by-hour": "Vertrek per uur", 
    "departures-by-hour-minutes-route": "(minuten/route)", 
    "departures-not-found": "Helaas zijn er geen vertrektijden gevonden voor de geselecteerde haltes", 
    "departures-not-found-time-threshold": "Helaas zijn er geen vertrektijden gevonden voor de geselecteerde haltes. Het is mogelijk dat de geselecteerde dag te ver in de toekomst ligt. ", 
    description: "Vind openbaar vervoer naar locaties in de buurt en ver.", 
    destination: "Bestemming", 
    "destination-defined": "Bestemming bepalen", 
    "destination-outside-service": "Er werden geen routevoorstellen gevonden omdat de bestemming buiten het servicegebied ligt.", 
    "destination-placeholder": "Voer bestemming, route of stop in", 
    "dialog-return-to-map": "Terug naar kaart", 
    "digitransit-platform": "Digitransit service platform", 
    disclaimer: "Houd er rekening mee dat de resultaten gebaseerd zijn op geschatte reistijden. De voorgestelde vervoersverbindingen kunnen niet worden gegarandeerd.", 
    disruption: "Storing", 
    "disruption-info": "Storingsmeldingen", 
    "disruption-info-no-alerts": "Geen bekende storingsmeldingen", 
    "disruption-info-route-no-alerts": "Geen storingsmeldingen op deze route.", 
    disruptions: "Storingen", 
    "disruptions-and-diversions": "Storingen en omleidingen", 
    "disruptions-tab.sr-disruptions": "Een of meer bekende verstoringen", 
    "disruptions-tab.sr-no-disruptions": "Geen verstoringen bekend", 
    "distance-between": "Afstand {distance1} m", 
    "distance-total": "Totale afstand", 
    "distance-under": "Afstand kleiner dan {distance} m", 
    earlier: "Eerdere vertrekken", 
    "edit-favourites": "Bewerk de locatie in de Favorieten", 
    "elevation-gained-total": "Bergop", 
    "elevation-lost-total": "Bergaf", 
    "embedded-search.choose-language": "Taal", 
    "embedded-search.choose-mode": "Vervoermiddelen", 
    "embedded-search.choose-width-component": "Breedte van de inbedding", 
    "embedded-search.form-heading": "Inbeddingsinstrumenten", 
    engine_ignition_aid: "Motorstarthulp", 
    english: "Engels", 
    explanations: "Toelichting", 
    "extra-info": "Meer informatie", 
    "favourite-failed-text": "Probeer het nog eens.", 
    "favourite-target": "Favoriete locatie", 
    ferry: "Veerboot", 
    "ferry-with-route-number": "Veerboot {routeNumber} {headSign}", 
    "fetch-new-route": "Een nieuwe route ophalen", 
    finnish: "Fins", 
    "free-of-charge": "Vrij", 
    "from-ferry": "Veerboot", 
    "from-rail": "trein", 
    "from-station": "vanaf treinstation", 
    "from-stop": "van halt.", 
    "from-subway": "metro", 
    frontpage: "Startpagina", 
    funicular: "Kabelbaan", 
    "generic-cancelation": "{mode} {route} {headsign} op {time} wordt geannuleerd.", 
    "generic-error": "Er is een fout opgetreden", 
    "geolocate-yourself": "Detecteer uw locatie", 
    "geolocation-denied-heading": "Geolocatie geweigerd", 
    "geolocation-denied-text": "Toegang tot de locatie is niet toegestaan. Controleer de instellingen van uw browser.", 
    "geolocation-failed-heading": "Locatiebepaling mislukt", 
    "geolocation-failed-text": "Uw browser ondersteunt geen toegang tot de locatie", 
    "geolocation-prompt-text": "Geef toegang tot de locatie", 
    "geolocation-timeout-heading": "Locatiebepaling duurt langer dan verwacht.", 
    "geolocation-timeout-text": "Heeft u uw browseraanvraag geaccepteerd om toegang te krijgen tot uw locatie?", 
    "give-destination": "Bestemming invoeren", 
    "give-name-to-location": "Geef de locatie een beschrijvende naam", 
    "give-origin": "Start invoeren.", 
    "give-position": "Voer je positie in het zoekveld in.", 
    "give-route": "Zoek verbinding ", 
    hour: "Uur", 
    "hour-short": "h", 
    "how-to-rate-service": "Hoe zou u de service beoordelen?", 
    hsl_mobile_ticket: "HSL mobiele ticket", 
    hsl_ticket: "HSL-ticket", 
    hsl_travel_card: "HSL-kaart", 
    "in-addition": "Bovendien", 
    "index.title": "Reisplanner", 
    inquiry: "Hoe heb je de nieuwe reisplanner gevonden? Vertel het ons alsjeblieft!", 
    instructions: "Instructies", 
    "is-open": "Openen:", 
    "itinerary-details.biking-leg": "Bij {time} cyclus {distance} van {origin} naar {to} {destination}. Geschatte tijd {duration}", 
    "itinerary-details.car-leg": "Op {time} station {distance} van {origin} naar {to} {destination}. Geschatte tijd {duration}", 
    "itinerary-details.carpool-leg": "Op {time} reis {distance} via carpool van {origin} naar {to} {destination}. Geschatte tijd {duration}", 
    "itinerary-details.end-leg": "Bij {time} aankomt u op bestemming {destination}.", 
    "itinerary-details.route-has-info-alert": "Route bevat waarschuwingen.", 
    "itinerary-details.route-has-severe-alert": "De route is verstoord.", 
    "itinerary-details.route-has-unknown-alert": "De route is verstoord.", 
    "itinerary-details.route-has-warning-alert": "De route is verstoord.", 
    "itinerary-details.scooter-leg": "Op {time} rijdt je kick scooter {distance} van {origin} naar {destination}. Geschatte tijd {duration}", 
    "itinerary-details.transit-leg-part-1": "Bij {time} nemen {realtime}", 
    "itinerary-details.transit-leg-part-2": "vanaf stop {startStop} {startZoneInfo} {trackInfo} om {endStop} {endZoneInfo} te stoppen. Geraamde duur {duration}", 
    "itinerary-details.via-leg": "{arrivalTime} komt via {viaPoint} aan. {leaveAction}", 
    "itinerary-details.walk-leg": "Bij {time} lopen {distance} van {origin} naar {to} {destination}. Geschatte tijd {duration}", 
    "itinerary-feedback-button": "Stuur feedback", 
    "itinerary-feedback-message": "Kon je niet vinden wat je zocht?", 
    "itinerary-feedback-placeholder": "Beschrijving (facultatief)", 
    "itinerary-hide-stops": "Tussenstops verbergen", 
    "itinerary-in-the-past": "De verbinding ligt in het verleden.", 
    "itinerary-in-the-past-link": "Vertrek nu ›", 
    "itinerary-in-the-past-title": "De verbindingsopties kunnen niet worden weergegeven", 
    "itinerary-page.description": "Reisbeschrijving", 
    "itinerary-page.hide-details": "Details verbergen", 
    "itinerary-page.itineraries-loaded": "Zoekresultaten geladen", 
    "itinerary-page.itineraries-updated": "Zoekresultaten bijgewerkt", 
    "itinerary-page.loading-itineraries": "Zoekresultaten downloaden", 
    "itinerary-page.show-details": "Routebeschrijving tonen", 
    "itinerary-page.show-details-label": "Routebeschrijving {number} details tonen", 
    "itinerary-page.title": "Reisbeschrijving", 
    "itinerary-page.update-alert": "Zoekresultaten bijgewerkt", 
    "itinerary-summary-page-street-mode.update-alert": "Loop- en fietsresultaten bijgewerkt", 
    "itinerary-summary-page.description": "Reissuggesties", 
    "itinerary-summary-page.title": "Reissuggesties", 
    "itinerary-summary-row.biking-distance": "Totale fietsafstand {totalDistance}.", 
    'itinerary-summary-row.steps.direction.DEPART': 'Begin op {street} {direction}',
    'itinerary-summary-row.steps.direction.HARD_LEFT':
      'Sla scherp linksaf naar {street}',
    'itinerary-summary-row.steps.direction.LEFT': 'Sla linksaf naar {street}',
    'itinerary-summary-row.steps.direction.SLIGHTLY_LEFT':
      'Houd iets links aan op {street}',
    'itinerary-summary-row.steps.direction.RIGHT': 'Sla rechtsaf naar {street}',
    'itinerary-summary-row.steps.direction.SLIGHTLY_RIGHT':
      'Houd iets rechts aan op {street}',
    'itinerary-summary-row.steps.direction.HARD_RIGHT':
      'Sla scherp rechtsaf naar {street}',
    'itinerary-summary-row.steps.direction.CONTINUE': 'Rijd rechtdoor op {street}',
    'itinerary-summary-row.steps.direction.UTURN_LEFT':
      'Sla af bij {street}',
    'itinerary-summary-row.steps.direction.UTURN_RIGHT':
      'Sla af bij {street}',
    'itinerary-summary-row.steps.direction.CIRCLE_COUNTERCLOCKWISE':
      'Rijd de rotonde op en neem de {exit} afslag naar {street}',
    'itinerary-summary-row.steps.direction.CIRCLE_CLOCKWISE':
      'Ga de rotonde links op en neem de {exit} met de klok mee naar {street}',
    'itinerary-summary-row.steps.direction.ELEVATOR': 'Neem de lift naar {street}',
    'itinerary-summary-row.steps.direction.ENTER_STATION': 'Ga het station binnen bij {street}',
    'itinerary-summary-row.steps.direction.EXIT_STATION': 'Verlaat het station in de richting van {street}',
    'itinerary-summary-row.steps.direction.FOLLOW_SIGNS': 'Volg de borden naar {street}',
    'itinerary-summary-row.steps.direction.NORTH': 'in noordelijke richting',
    'itinerary-summary-row.steps.direction.NORTHEAST': 'in noordoostelijke richting',
    'itinerary-summary-row.steps.direction.EAST': 'richting het oosten',
    'itinerary-summary-row.steps.direction.SOUTHEAST': 'in zuidoostelijke richting',
    'itinerary-summary-row.steps.direction.SOUTH': 'richting het zuiden',
    'itinerary-summary-row.steps.direction.SOUTHWEST': 'richting zuidwesten',
    'itinerary-summary-row.steps.direction.WEST': 'richting het westen',
    'itinerary-summary-row.steps.direction.NORTHWEST': 'in noordwestelijke richting',
    "itinerary-summary-row.clickable-area-description": "Tonen op de kaart:", 
    "itinerary-summary-row.description": "Route vertrekt op {departureDate} {departureTime} en komt aan op {arrivalDate} {arrivalTime}. {firstDeparture} {transfers} Totale tijd {totalTime}.", 
    "itinerary-summary-row.first-departure": "{vehicle} vertrekt op {departureTime} vanaf halte {stopName}.", 
    "itinerary-summary-row.first-leg-start-time": "Verlaat op {firstDepartureTime} {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform}", 
    "itinerary-summary-row.first-leg-start-time-citybike": "Vertrek op {firstDepartureTime} vanaf {firstDepartureStop} fietsstation", 
    "itinerary-summary-row.no-transit-legs": "Start mogelijk op elk moment", 
    "itinerary-summary-row.transfers": "Overstappen naar {vehicle} bij halte {stopName}", 
    "itinerary-summary-row.walking-distance": "Totale loopafstand {totalDistance}.", 
    "itinerary-summary.bikeAndPublic-fallback-title": "Neem je fiets mee aan boord", 
    "itinerary-summary.bikeAndPublic-rail-subway-title": "Neem je fiets mee in de trein of in de metro", 
    "itinerary-summary.bikeAndPublic-rail-title": "Neem je fiets mee in de trein", 
    "itinerary-summary.bikeAndPublic-subway-title": "Neem je fiets mee in de metro", 
    "itinerary-summary.bikePark-title": "Laat uw fiets achter bij een Park & Ride", 
    "itinerary-summary.interline-wait": "Het routenummer ({shortName}) en de bestemming ({destination}) zullen veranderen bij de {stop} stop. De wachttijd bij de halte is {time}. Wacht aan boord.", 
    "itinerary-summary.interline-wait-multiple-legs": "Het routenummer ({shortName}) en de bestemming veranderen meerdere keren tijdens de reis. Totale wachttijd is {time}. Verlaat alstublieft het voertuig niet.", 
    "itinerary-summary.show-on-map": "Toon op kaart {target}", 
    "itinerary-ticket.title": "Ticket vereist", 
    "itinerary-tickets.title": "Tickets vereist.", 
    "itinerary-time.title": "Duur", 
    "itinerary-walk.title": "Totale loopafstand", 
    "journeyplanner.title": "HSL reisplanner", 
    "last-updated": "Laatst bijgewerkt {time}", 
    "language-selection": "Taal: {language}", 
    later: "Latere vertrekken", 
    "leave-your-car-park-and-ride": "Laat uw auto op Park & Ride site", 
    leaves: "Vertrek", 
    "leaving-at": "Vertrek om", 
    lighting: "Verlichting", 
    "likely-to-recommend": "Hoe waarschijnlijk is het dat u onze service aan anderen zou aanbevelen?", 
    "likely-to-use": "Hoe waarschijnlijk zou u deze service blijven gebruiken in plaats van uw huidige service?", 
    loading: "Laden...", 
    localadmin: "Plaats", 
    locate: "Locatie detecteren", 
    "location-examples": "bijvoorbeeld thuis, werk, school,...", 
    "location-from-map": "Geselecteerde locatie", 
    "location-from-map-confirm": "Selectie bevestigen", 
    "location-home": "Thuis", 
    "location-school": "School", 
    "location-shopping": "Winkelen", 
    "location-sport": "Sport", 
    "location-work": "Werk", 
    login: "Aanmelden", 
    "login-content": "Om plaatsen, routes en stops op te slaan en te gebruiken, moet u zich aanmelden via uw HSL-account.", 
    "login-header": "Log eerst in", 
    logout: "Afmelden", 
    "long-transfers-margin": "12 min", 
    "main-menu-label-close": "Hoofdmenu sluiten", 
    "main-menu-label-open": "Hoofdmenu openen", 
    "main-mode": "Ik reis met", 
    map: "Kaart", 
    "map-layer-charging-stations": "Oplaadpunten ", 
    "map-layer-citybike": "Fietsverhuurstations", 
    "map-layer-park-and-ride": "Park & Ride plaatsen", 
    "map-layer-bike-parks": "Fietsparkeerplaatsen", 
    "map-layer-stop-bus": "Bushaltes", 
    "map-layer-stop-ferry": "Veerboot", 
    "map-layer-stop-funicular": "Kabelbanen", 
    "map-layer-stop-tram": "Tramhaltes", 
    "map-layer-terminal-bus": "Busstations", 
    "map-layer-terminal-rail": "Treinstations", 
    "map-layer-terminal-subway": "Metrostations", 
    "map-layer-vehicles": "Voertuigen", 
    "map-layer-dynamic-parking-lots": "Parkeerplaatsen", 
    "menu-faq": "VEELGESTELDE VRAGEN", 
    "menu-feedback": "Stuur feedback", 
    "menu-link-to-privacy-policy": "Gegevensbescherming", 
    "messagebar-label-close-message-bar": "Banner sluiten", 
    "messagebar-label-page": "Bladzijde", 
    "minute-short": "min", 
    minutes: "min", 
    "minutes-or-route": "Min / Route", 
    "missing-price-info-disclaimer": "Geen prijsinformatie", 
    "modes.to-bike": "Naar het fietsverhuurstation", 
    "modes.to-bike-park": "Naar de fietsparkeerplaats", 
    "modes.to-bus": "Naar de bushalte", 
    "modes.to-car-park": "Naar de parkeerplaats", 
    "modes.to-place": "Naar de bestemming", 
    "modes.to-rail": "Naar het treinstation", 
    "modes.to-stop": "Naar de halte", 
    "modes.to-subway": "Naar het metrostation", 
    "modes.to-tram": "Naar de tramhalte", 
    "more-departures": "Andere vertrekken", 
    "more-settings": "Meer instellingen", 
    "move-on-map": "Op de kaart zetten", 
    "move-to-tab": "Naar naar tabblad {number}", 
    navigate: "Navigeren", 
    nearest: "{modus} dichtbij je", 
    "nearest-favorites": "Stopt in de buurt:", 
    "nearest-favorites-browse-stops": "Stops weergeven en selecteren", 
    "nearest-favorites-no-favorites": "Vertrektijden voor geselecteerde haltes en voertuigen op de kaart", 
    "nearest-no-stops": "Er zijn geen haltes voor de door jou geselecteerde vervoersmiddelen in de buurt.", 
    "nearest-stops": "Dichtstbijzijnde haltes", 
    "nearest-stops-airplane": "luchthavens", 
    "nearest-stops-bus": "bushaltes", 
    "nearest-stops-carpool": "carpool", 
    "nearest-stops-citybike": "fietsverhuurstations", 
    "nearest-stops-favorite": "Stops in de omgeving", 
    "nearest-stops-ferry": "Dichtstbijzijnde veerboot terminals", 
    "nearest-stops-rail": "Dichtstbijzijnde treinstations", 
    "nearest-stops-subway": "Dichtstbijzijnde metrostations ", 
    "nearest-stops-tram": "Dichtstbijzijnde tramhalte", 
    "nearest-stops-update-location": "{mode} bijwerken", 
    "nearest-stops-updated-location": "Positie op de kaart is veranderd", 
    "network-error": "Netwerkfout", 
    neighbourhood: "Buurt", 
    next: "Volgende", 
    "no-bike-allowed-popup-train": "Fietsen zijn toegestaan op pendeltreinen, maar op langeafstandstreinen moet u een extra vergoeding betalen en het kan een reservering vereisen.", 
    "no-bike-allowed-popup-tram-bus": "Fietsen zijn niet toegestaan in bussen en trams. Laat je fiets achter bij de bushalte of in de Park&Ride parkeergarages als je deze vervoersmiddelen gebruikt.", 
    "no-departures": "Geen vertrek", 
    "no-position": "Geen locatie", 
    "no-position-no-stops": "De volgende haltes kunnen niet worden getoond omdat je locatie onbekend is.", 
    "no-route-already-at-destination": "U bent al op uw bestemming.", 
    "no-route-end": "Selecteer bestemming", 
    "no-route-end-date-not-in-range": "Latere vertrektijden zijn niet opgenomen in de dienstregeling.", 
    "no-route-found": "Helaas kon route {shortName} ({longName}) niet gevonden worden.", 
    "no-route-msg": "We hebben geen reissuggesties voor deze route gevonden. ", 
    "no-route-msg-time-threshold": "Helaas hebben we geen verbindingsvoorstellen kunnen vinden. Het is mogelijk dat er nog geen dienstregelingsgegevens beschikbaar zijn voor de dag die je hebt geselecteerd. Probeer het een paar dagen voor je vertrek nog eens.", 
    "no-route-msg-with-changes": "Sorry, er zijn geen reisopties gevonden voor je vraag. Pas uw instellingen, vertrek of bestemming aan.", 
    "no-route-origin-near-destination": "De afstand tussen start en finish is erg kort. Verander een van deze locaties.", 
    "no-route-origin-same-as-destination": "Geen reissuggesties gevonden, aangezien vertrek en bestemming overeenkomen.", 
    "no-route-showing-alternative-options": "Geen routevoorstellen gevonden met jouw instellingen. In plaats daarvan hebben we de volgende reisopties gevonden:", 
    "no-route-start": "Selecteer de startlocatie", 
    "no-route-start-date-too-early": "Er zijn geen eerdere vertrekken.", 
    "no-route-start-end": "Selecteer start en bestemming.", 
    "no-transfers-margin": "1 min", 
    "no-trips-found": "Geen reizen gevonden voor deze dag ({selectedDate}).", 
    "notification-minimize": "Bericht sluiten", 
    "notification-open": "Bericht openen", 
    now: "Nu", 
    "number-of-intermediate-stops": "{aantal, meervoud, =0 {No stops} één {1 stop} andere {{number} stops} }", 
    "number-of-minutes": "{nummer, meervoud, =0 {0 minuten} één {1 minuut} andere {{number} minuten}", 
    "number-of-spaces": "Aantal parkeerplaatsen:", 
    "off-canvas-info": "Log in op de service om je favorieten op te slaan en ze op andere apparaten te gebruiken", 
    "occupancy-status-FEW_SEATS_AVAILABLE": "gemiddelde bezetting", 
    "occupancy-status-MANY_SEATS_AVAILABLE": "lage bezetting", 
    "occupancy-status-STANDING_ROOM_ONLY": "hoge bezetting", 
    "occupancy-status-EMPTY": "Zeer lage bezetting ", 
    "only-public-transport-disclaimer": "Prijsinformatie alleen geldig voor OV.", 
    "open-24-7": "24/7 openen", 
    "option-default": "standaard", 
    "option-least": "Langzaam", 
    "option-less": "Rustig", 
    "option-more": "Waarschuwing", 
    "option-most": "Snel", 
    or: "of", 
    origin: "Begin", 
    "origin-and-destination": "Vertrek en aankomst", 
    "origin-defined": "Startlocatie bepaald", 
    "origin-outside-service": "Er werden geen routesuggesties gevonden omdat het startpunt buiten het servicegebied ligt.", 
    "origin-placeholder": "- adres of stop", 
    "other-dates": "Andere data", 
    "own-position": "Actuele locatie", 
    "page-not-found": "De pagina kan niet gevonden worden.", 
    paid: "Betaald", 
    "park-and-ride": "Park and Ride", 
    "park-and-ride-availability": "Beschikbare plaatsen:", 
    "pay-attention": "Attentie!", 
    payment_at_gate: "Betaling aan de poort", 
    "pick-icon": "Pictogram selecteren", 
    "pick-mode": "Een transportmiddel kiezen", 
    "pick-mode-airplane-disabled": "Vlucht niet geselecteerd", 
    "pick-mode-airplane-enabled": "Vlucht geselecteerd", 
    "pick-mode-bus-disabled": "Bus niet geselecteerd", 
    "pick-mode-bus-enabled": "Bus geselecteerd", 
    "pick-mode-citybike-disabled": "Huurfiets niet geselecteerd", 
    "pick-mode-citybike-enabled": "Huurfiets geselecteerd", 
    "pick-mode-ferry-disabled": "veerboot niet geselecteerd", 
    "pick-mode-ferry-enabled": "veerboot geselecteerd", 
    "pick-mode-rail-disabled": "Trein niet geselecteerd", 
    "pick-mode-rail-enabled": "Trein geselecteerd", 
    "pick-mode-selected": "Geselecteerde transportmiddelen", 
    "pick-mode-subway-disabled": "Metro niet geselecteerd", 
    "pick-mode-subway-enabled": "Metro geselecteerd", 
    "pick-mode-tram-disabled": "Tram niet geselecteerd", 
    "pick-mode-tram-enabled": "Tram geselecteerd", 
    "pick-street-mode": "Mijn reisopties", 
    "place-route-or-keyword": "Adres of stopplaats", 
    platform: "Spoor", 
    "platform-num": "Spoor {platformCode}", 
    "platform-short": "Spoor {platformCode}", 
    "platform-short-no-num": "Spoor", 
    position: "Positie", 
    precipitation: "Neerslag", 
    "precipitation-hail": "hagel", 
    "precipitation-icy-rain": "ijsregen", 
    "precipitation-none": "geen", 
    "precipitation-rain": "regen", 
    "precipitation-sleet": "sneeuwregen", 
    "precipitation-snow": "sneeuw", 
    "precipitation-unknown": "onbekend", 
    "prefer-walking": "Liever lopen", 
    preview: "Voorbeeld", 
    previous: "Vorige", 
    print: "Afdrukken", 
    "print-timetable": "Dienstregeling", 
    "privacy-statement": "Privacybeleid", 
    "public-transport": "Openbaar vervoer (OV)", 
    rail: "Trein", 
    "rail-with-route-number": "Trein {routeNumber} {headSign}", 
    "read-more": "Lees meer", 
    realtime: "Realtime", 
    "realtime-matching": "Integratie in real time", 
    releases: "Bekendmakig", 
    "remove-favourite": "Uit favorieten verwijderen", 
    "remove-via-button-label": "Via punt verwijderen {{index}}", 
    "rent-bicycle-at": "Huur een fiets:", 
    "rent-car-at": "Huur een auto:", 
    "rent-scooter-at": "Huur een scooter bij {station}", 
    "required-ticket": "Ticket nodig voor de reis", 
    "return-bicycle-to": "Breng de fiets terug:", 
    "return-scooter-to": "Breng de scooter terug naar {station}", 
    "right-now": "Nu ", 
    "road-condition-dry": "droog", 
    "road-condition-frosty": "vorst", 
    "road-condition-icy": "ijs", 
    "road-condition-moist": "vochtig", 
    "road-condition-moist-salty": "vochtig/zoutachtig", 
    "road-condition-snowy": "sneeuw", 
    "road-condition-unknown": "onbekend", 
    "road-condition-wet": "nat", 
    "road-condition-wet-salty": "nat/zoutachtig", 
    "road-temperature": "Wegtemperatuur", 
    "road-weather": "wegweer", 
    route: "Route", 
    "route-add-viapoint": "Via punt", 
    "route-custom-settings": "Aangepaste instellingen", 
    "route-default": "Standaardinstellingen", 
    "route-destination-arrives": "Alleen uitstappen", 
    "route-destination-endpoint": "Aankomst / eindpunt", 
    "route-fastest": "Snelle route", 
    "route-from-here": "Route vanaf hier", 
    "route-guide": "Routebeschrijving", 
    "route-here": "Bestemming", 
    "route-least-elevation-changes": "Vermijd hoogteveranderingen", 
    "route-least-transfers": "Vermijd overstappen", 
    "route-least-walking": "Vermijd lopen", 
    "route-no-stop": "Geen stop", 
    "route-not-possible": "Helaas is de route niet beschikbaar. Technische fout: \"{error}\"", 
    "route-page-vehicle-position": "{mode} {shortName} is bij de {stopName} stop", 
    "route-page-vehicle-position-between": "{mode} {shortName} ligt tussen de {stopName} stop en de {nextStopName} stop.", 
    "route-page-vehicle-selected": "Huidige selectie.", 
    "route-page.description": "Route {shortName} - {longName}", 
    "route-page.future-routes": "Toekomstige routes", 
    "route-page.pattern-chosen": "Geselecteerd", 
    "route-page.pattern-select-title": "Selecteer de te bekijken route", 
    "route-page.similar-routes": "Dit kan je ook interesseren", 
    "route-page.special-routes": "Andere routes", 
    "route-page.title": "Route {shortName}", 
    "route-page.title-short": "Route", 
    "route-to-ferry": "Route naar de pier", 
    "route-to-park": "Route naar parkeerplaatsen", 
    "route-to-station": "Route naar het station", 
    "route-to-stop": "Route naar de halte", 
    "router-change-departure-time": "Verander vertrektijd ›", 
    "router-location-not-found": " Delecteer een adres in de buurt van een straat of bushalte", 
    "router-location-not-found-title-1": "Er is geen gedefinieerde toegang tot de bestemming", 
    "router-location-not-found-title-2": "Er is geen gedefinieerde toegang tot de oorsprong", 
    "router-location-not-found-title-3": "Er is geen gedefinieerde toegang tot de oorsprong en de bestemming", 
    "router-only-walk": "Geen snellere alternatieven dan lopen zijn beschikbaar voor de route die u zocht.", 
    "router-only-walk-title": "Loop de route", 
    "router-outside-bounds-3": "Er zijn geen routesuggesties gevonden, omdat het begin en de bestemming buiten het dekkingsgebied liggen.", 
    "router-outside-service-period": "Geen vertrekinformatie beschikbaar voor de geselecteerde tijd.", 
    "router-stops-in-range-1": "Er zijn geen haltes in de buurt van de bestemming.", 
    "router-stops-in-range-2": "Er zijn geen bushaltes in de buurt van het startpunt.", 
    "router-stops-in-range-3": "Er zijn geen stops bij de start- en finishpunten.", 
    "router-system-error": "Er is een systeemfout opgetreden. Probeer het later nog eens.", 
    "router-transit-connection": "Probeer het start- of bestemmingsadres te wijzigen.", 
    "router-transit-connection-in-search-window": "Er zijn geen reizen beschikbaar op de gevraagde tijd.", 
    "router-unable": "Geen reisopties gevonden.", 
    routes: "Routes", 
    "routes-platforms": "Routes en platforms", 
    "routes-tracks": "Routes en sporen", 
    run: "Uitvoeren", 
    save: "Opslaan", 
    "scooter-availability": "{amount} Scooters zijn nu beschikbaar op het station", 
    "scooter-distance-duration": "Rijden met je scooter {duration} ({distance})", 
    "scooter-register-required": "Registratie is nodig om Scooter te gebruiken", 
    "scooterwalk-distance-duration": "Scooter duwen {duration} ({distance})", 
    search: "Zoeken", 
    "search-button-label": "Zoeken", 
    "search-destination": "Bestemming, lijn of halte zoeken", 
    "search-destination-index": "Bestemming invoeren", 
    "search-destination-results-but-no-search": "Bekijk de resultaten in het aangrenzende destination tabblad", 
    "search-fields.sr-instructions": "De route wordt automatisch gezocht wanneer je de start- en bestemmingslocaties opgeeft. Als je de zoekparameters wijzigt, wordt er opnieuw gezocht. De zoekvelden openen met de tab-toets", 
    ...
    "search-search-results-but-no-destination": "Bekijk de resultaten in de aangrenzende", 
    "searching-position": "Zoek huidige locatie...", 
    "select-all-routes": "Alle routes selecteren", 
    "select-map-layers-header": "Tonen op kaart", 
    "select-position": "Selecteer uw locatie uit uw vorige zoekopdrachten", 
    "select-route": "Selecteer {mode} route {shortName} naar {headsign}", 
    "selected-routes": "Selecteer verbinding", 
    send: "Verzenden", 
    "separate-ticket-required": "Voor een deel van de route is een apart ticket nodig.", 
    "separate-ticket-required-disclaimer": "De route bevat een of meer secties waarvoor {agencyName} geen tickets verkoopt.", 
    "set-specific-settings": "Meer specifieke instellingen instellen", 
    "set-stop-as-routes": "Stel de halte in als route", 
    settings: "Instellingen", 
    "settings-alternative-name-rail": "Trein", 
    "settings-change-itinerary-settings": "Instellingen wijzigen", 
    "settings-dropdown-close-label": "Opties sluiten", 
    "settings-dropdown-open-label": "Opties openen", 
    "layer-dropdown-close-label": "Laagopties sluiten", 
    "layer-dropdown-open-label": "Laagopties openen", 
    "settings-label-change": "Instellingen wijzigen", 
    "settings-missing-itineraries-body": "Sommige geselecteerde instellingen sluiten alternatieve routes uit.", 
    "settings-missing-itineraries-header": "Zijn er geen alternatieve routes?", 
    share: "Route delen", 
    show: "Tonen", 
    "show-departures": "Vertrek tonen", 
    "show-more": "Meer tonen", 
    "show-more-stops-near-you": "Toon meer haltes in de buurt", 
    "show-routes": "Kies routes", 
    "skip-positioning": "Overslaan", 
    "skip-to-content": "Ga naar inhoud", 
    slow: "Langzaam", 
    "specify-location": "Locatie opgeven", 
    "splash-locating": "Zoek locatie.", 
    "splash-or-choose": "of kies een van deze vertrekpunten", 
    "splash-use-positioning": "Huidige locatie gebruiken", 
    "splash-welcome": "Hoe wil je beginnen?", 
    "splash-you-can-also": "of", 
    station: "Station", 
    stop: "Halte ", 
    "stop-departure-time-future": "Vertrek over {minuten} minuten", 
    "stop-departure-time-past": "De vertrektijd was", 
    "stop-list-update.sr-instructions": "Vertrektijden voor elke halte worden in realtime weergegeven.", 
    "stop-near-you": "Zoeken naar haltes en lijnen  ", 
    "stop-near-you-modal-grant-permission": "of activeer de locatiefunctie", 
    "stop-near-you-modal-grant-permission-info": "Je kunt de locatieopvraag van je smartphone of browser delen, zodat deze service je huidige locatie kan gebruiken.", 
    "stop-near-you-modal-header": "U hebt de locatiediensten niet ingeschakeld", 
    "stop-near-you-modal-info": "Om de functie \"Haltes in de buurt\" te gebruiken, is toegang tot de locatie vereist.", 
    "stop-near-you-title": "Zoeken naar haltes of lijnen", 
    "stop-near-you-update-alert": "Volgende haltes bijgewerkt", 
    "stop-number": "Stopnummer", 
    "stop-page.description": "Stop {name} - {code}", 
    "stop-page.right-now.loaded": "pagina geladen stoppen", 
    "stop-page.title": "Stop {name} - {code}", 
    "stop-page.title-short": "Stop ", 
    "stop-virtual-monitor": "Scherm stoppen", 
    stops: "Stop / Haltes", 
    "stops-near-you.description": "Stop dienstregelingen en voertuigen in de buurt van uw", 
    "stops-near-you.title": "Dienstregeling van de haltes in de buurt", 
    "street-mode-bicycle": "Fiets", 
    "street-mode-bike-aria": "Laat de fietsroute zien. Duur {duration}, afstand {length}", 
    "street-mode-bikeandvehicle-aria": "Toon een combinatie van fietsen en openbaar vervoer. Duur {duration}, afstand {length}", 
    "street-mode-car": "Auto", 
    "street-mode-car-aria": "Route tonen. Duur {duur}, afstand {lengte}", 
    "street-mode-car_park": "Parkeren & rijden", 
    "street-mode-parkandride-aria": "Combinatie van auto en openbaar vervoer (OV) tonen. Duur {duur}, waarvan {lengte} met de auto", 
    "street-mode-public_transport": "Openbaar vervoer (OV)", 
    "street-mode-scooter": "Scooter", 
    "street-mode-scooter-aria": "Toon scooter en openbaar vervoer (OV) route. Duur {duur}, {lengte} per scooter", 
    "street-mode-walk": "Lopen ", 
    "street-mode-walk-aria": "Toon voetpad. Duur {duur}, afstand {lengte}", 
    "street-mode-ondemandtaxi-aria": "Toon oproep taxi. Duur {duur}, afstand {lengte}", 
    street: "Straat", 
    subway: "Metro", 
    "subway-with-route-number": "Metro {routeNumber} {headSign}", 
    "summary-page.description": "{from} - {to}", 
    "summary-page.row-label": "Reissuggestie {number}", 
    "summary-page.title": "Reissuggesties", 
    surveillance_cameras: "Bewakingscamera's", 
    "swap-order-button-label": "Start en finish verwisselen.", 
    swedish: "Zweeds", 
    "swipe-disruption-info": "Disruption info wipe result tabs", 
    "swipe-disruption-info-header": "Disruption info swipe resultaat tabbladen.", 
    "swipe-message-bar": "Tabbladen van het resultaat van het bericht", 
    "swipe-message-bar-header": "Tabbladen voor het verwijderen van het resultaat van berichten.", 
    "swipe-result-tab-left": "Druk op Enter of Spatie om het vorige tabblad te tonen.", 
    "swipe-result-tab-right": "Druk op Enter of Spatie om het volgende tabblad te tonen.", 
    "swipe-result-tabs": "Schakel tabbladen met pijltjestoetsen.", 
    "swipe-sr-new-tab-opened": "Tabblad {number} geopend.", 
    "swipe-stops-near-you": "Stopt in de buurt van je swipe resultaat tabs.", 
    "swipe-stops-near-you-header": "Stopt in de buurt van je swipe resultaat tabs", 
    "swipe-summary-page": "Tabbladen voor route-swipe-resultaten", 
    "swipe-summary-page-header": "Tabbladen voor het wegneemresultaat.", 
    "terminal-page.description": "Terminal {name}", 
    "terminal-page.title": "Terminal {name}", 
    "terminal-page.title-short": "Terminal", 
    "terms-of-use": "Gebruiksvoorwaarden", 
    "ticket-and-price-info": "Ticket- en prijsinformatie", 
    "ticket-single-adult": "Volwassenen", 
    "ticket-type-none": "Geen tariefzonebeperkingen", 
    tickets: "Tickets", 
    time: "Tijd", 
    "time-selector-hours-label": "Uur", 
    "time-selector-minutes-label": "Minuut", 
    timetable: "Reisplanner ", 
    "to-frontpage": "Terug naar de startpagina", 
    "to-rail": "trein", 
    "to-subway": "metro", 
    today: "Vandaag", 
    tomorrow: "Morgen", 
    track: "Track", 
    "track-num": "spoor {platformCode}", 
    "track-short": "spoor {platformCode}", 
    "track-short-no-num": "spoor  ", 
    tram: "Tram", 
    "tram-with-route-number": "Tram {routeNumber} {headSign}", 
    transfers: "Aantal overdrachten", 
    "transfers-allowed": "Overdracht toegestaan", 
    "transfers-margin": "Overdrachtsmarge ten minste", 
    "travel-time": "{min} min", 
    "travel-time-label": "Reistijd", 
    "travel-time-with-hours": "{h} u {min} min", 
    "trip-co2-emissions": "CO2-uitstoot van de reis", 
    "trip-information": "Reisinformatie", 
    "trip-page.description": "Route {route_short_name} - {route_long_name}", 
    "trip-page.title": "Route {route_short_name}", 
    "try-again": "Probeer opnieuw", 
    "use-citybike": "Beginnen met gebruiken", 
    "use-national-service-postfix": ".", 
    "use-national-service-prefix": "We raden u aan de nationale reisplanner te proberen,", 
    "use-own-position": "Huidige positie gebruiken", 
    userinfo: "Mijn informatie", 
    usermenu: "Gebruikersmenu", 
    "using-modes": "Ik wil reizen met", 
    "vehicle-parking-operator": "Operator: {operator}", 
    "very-likely": "Zeer waarschijnlijk", 
    "very-unlikely": "Zeer onwaarschijnlijk", 
    "via-leg-stop-duration": "Via {stayDuration}", 
    "via-point": "Via punt", 
    "via-point-index": "Via punt {{index}}", 
    "viapoint-slack-amount": "Transfertijd", 
    "view-route": "Route tonen", 
    venue: "Plaats", 
    vr_ticket: "VR-ticket", 
    wait: "wacht  ", 
    "wait-amount-of-time": "Wachttijd {duration}", 
    walk: "lopen", 
    "walk-bike-itinerary-1": "Je zoekopdracht leverde alleen routes voor voetpaden op.", 
    "walk-bike-itinerary-2": "Je zoekopdracht leverde alleen fietsroutes op.", 
    "walk-bike-itinerary-3": "Je zoekopdracht leverde alleen routes voor voetpaden en fietsroutes op.", 
    "on-demand-taxi-itinerary": "Alleen routes met on-demand taxi's gevonden.", 
    "car-park-ride-itinerary": "Er is geen route gevonden die uitsluitend gebruik maakt van het openbaar vervoer (OV)", 
    "walk-bike-itinerary-4": "Je zoekopdracht leverde alleen routes voor voetpaden, fietsroutes en autoroute op.", 
    "walk-distance-duration": "Lopen {duration} ({distance})", 
    "walk-only": "Alleen lopen", 
    walking: "Lopen", 
    "walking-speed": "Loopsnelheid", 
    "warning-call-agency": "Alleen op aanvraag: {routeNaam}, die vooraf geboekt moet worden ", 
    "warning-call-agency-no-route": "Alleen op aanvraag. De reis moet vooraf geboekt worden", 
    weather: "Weer", 
    "weather-at-destination": "Weer op je bestemming", 
    "weather-data-source": "Bron: Fins Meteorologisch Instituut", 
    "weather-detail-title": "Weersvoorspelling voor de bestemming  op", 
    "weather-icon-1": "klaar", 
    "weather-icon-2": "bewolkt", 
    "weather-icon-21": "lichte buien", 
    "weather-icon-22": "bui", 
    "weather-icon-23": "Zware buien", 
    "weather-icon-3": "Bewolkt", 
    "weather-icon-31": "Lichte regen", 
    "weather-icon-32": "Regen", 
    "weather-icon-33": "Zware regenval", 
    "weather-icon-41": "Lichte sneeuwbuien", 
    "weather-icon-42": "Sneeuwbuien", 
    "weather-icon-43": "Zware sneeuwbuien", 
    "weather-icon-51": "Lichte sneeuwval", 
    "weather-icon-52": "Sneeuwval", 
    "weather-icon-53": "Zware sneeuwval", 
    "weather-icon-61": "Onweersbuien", 
    "weather-icon-62": "Zware onweersbui", 
    "weather-icon-63": "onweer ", 
    "weather-icon-64": "Zware onweer ", 
    "weather-icon-71": "Lichte natte sneeuwbui", 
    "weather-icon-72": "    stofhagelbui", 
    "weather-icon-73": "Zware stofhagelbui", 
    "weather-icon-81": "Lichte stofhagel", 
    "weather-icon-82": "stofhagelbui", 
    "weather-icon-83": "Zware natte sneeuw", 
    "weather-icon-91": "Nevel mist", 
    "weather-icon-92": "Mist", 
    where: "Waarheen?", 
    yesterday: "Gisteren", 
    zone: "Gebied", 
    "zone-info": "Zone {zone}", 
    "zone-unknown": "Onbekende zone", 
    zones: "Tarievenzones",
  },
};
