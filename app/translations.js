...
const translations = {
  "da":{
     ...
     "no-route-origin-near-destination":"No route suggestions were found because the origin and destination are very close to each other.",
  ...
  "de":{
    ...
    "accept-carpool-policy": "Ich habe die <a href=\"{policyUrl}\" target=\"_blank\">Datenschutzbestimmungen</a> und die <a href=\"{termsUrl}\" target=\"_blank\">AGB</a> gelesen und erkläre mich einverstanden.",
    ...
    "add-favourite-bikeStation-failed-heading": "Das Speichern der Citybike-Station ist fehlgeschlagen",
    "add-favourite-place-failed-heading": "Speicherort kann nicht gespeichert werden",
    "add-favourite-route-failed-heading": "Das Speichern der Route ist fehlgeschlagen",
    "add-favourite-station-failed-heading": "Das Speichern der Station ist fehlgeschlagen.",
    "add-favourite-stop-failed-heading": "Das Speichern des Stopps ist fehlgeschlagen",
    ...
    "add-to-favourites": "Fügen Sie zu Ihren Favoriten hinzu",
    "add-via-button-label": "Zwischenstopp hinzufügen",
    "add-via-duration-button-label": "Aufenthaltszeit am Zwischenstopp {index}",
    "add-via-duration-button-label-close": "Schließe Aufenthaltszeit-Auswahl am Zwischenstopp {index}",
    "add-via-duration-button-label-open": "Öffne Aufenthaltszeit-Auswahl am Zwischenstopp {index}",
    ...
    "alert:bikerental:free-floating-drop-off": "Ziel ist keine Rückgabestation. Ausleihe kann hier nicht abgeschlossen werden. Anbieterabhängig fallen weiter Gebühren bis zur Rückgabe an einer Station an.",
    "all-routes": "Alle Linien",
    "all-routes-disabled": "Keine Linien",
    "approx-meters": "{approxDistance} Meter",
    "aria-itinerary-summary": "Gesamtdauer {duration}. Route fährt ab {inFuture} {departureTime} mit Ankunft {arrivalTime}.",
    "aria-itinerary-summary-bike-distance": "Strecke per Rad {duration}, {distance} ",
    "aria-itinerary-summary-walk-distance": "Strecke zu Fuß {duration}, {distance} ",
    ...
    "canceled-itineraries-amount": "{itineraryAmount, plural, =1 {1 weitere} other {{itineraryAmount} weitere}} ausgefallene Verbindungen",
    "canceled-itineraries-amount-hide": "Ausgefallene Verbindungen ausblenden ({itineraryAmount})",
    ...
    "carpool-offer-success": "Ihr Inserat von {origin} nach {destination} wurde eingestellt.",
    ...
    "carpool-with-route-number": "Fahrgemeinschaft Route {routeNumber} nach {headsign}",
    "cause": "Grund",
    "char-left": "Zeichen",
    "choose-stop": "Haltestelle auswählen",
    "choose-stop-or-vehicle": "Fahrzeug auswählen oder anhalten",
    "choose-vehicle": "Fahrzeug auswählen",
    "chosen-times-once": "Sie haben für den folgendes Datum und Uhrzeit inseriert: ",
    ...
    "citybike-return-full": "Ein Citybike zurückgeben?",
    "citybike-return-full-link": "So geben Sie ein Fahrrad zurück, wenn eine Fahrradstation voll ist ›",
    "citybike-start-using": "Beginne Leihrad-Nutzung",
    "citybike-start-using-info": "Mehr Informationen",
    ...
    "day": "Tag",
    "delete": "Löschen",
    "delete-favourite-failed-heading": "Speichern kann nicht gelöscht werden",
    ...
    "departures-by-hour": "Abfahrten nach Stunde (Minuten / Strecke)",
    "description": "Finde Verkehrsverbindungen zu allen Orten. Egal ob Nah oder Fern.",
    "destination": "Zielort",
    "destination-label-change": "Zielort ändern",
    "destination-outside-service": "Leider konnte keine Route an diesen Zielort gefunden werden. Der Zielort befindet sich außerhalb des abgedeckten Gebietes. Bitte ändern Sie den Zielort.",
    "destination-placeholder": "Wohin reisen?",
    "dialog-return-to-map": "Zurück zur Karte",
    "digitransit-platform": "Digitransit-Plattform",
    "disclaimer": "Bitte beachten Sie, dass es sich um geschätzte Reisezeiten handelt. Die vorgeschlagenen Verbindungen können nicht garantiert werden.",
    "disruption": "Störung",
    ...
    "favourite-failed-text": "Bitte versuchen Sie es in einer Weile erneut.",
    ...
    "itinerary-details.biking-leg": "Um {time} {distance} mit dem Rad von {origin} nach {destination} fahren. Geschätzte Dauer: {duration}",
    "itinerary-details.car-leg": "Um {time} {distance} mit dem Auto von {origin} nach {destination} fahren. Geschätzte Dauer: {duration}",
    ...
    "itinerary-details.scooter-leg": "Um {time} {distance} mit dem Scooter von {origin} nach {destination} fahren. Geschätzte Dauer: {duration}",
    "itinerary-details.transit-leg-part-1": "Um {time} ",
    "itinerary-details.transit-leg-part-2": "von {startStop} {trackInfo} nach {endStop}. Geschätzte Dauer: {duration}",
    "itinerary-details.walk-leg": "Um {time} {distance} zu Fuß von {origin} nach {destination} laufen. Geschätzte Dauer: {duration}",
    ...
    "itinerary-page.itineraries-loaded": "Weitere Suchergebnisse heruntergeladen",
    "itinerary-page.loading-itineraries": "Weitere Suchergebnisse herunterladen",
    ...
    "itinerary-summary-page-street-mode.update-alert": "Walking and biking results updated",
    "itinerary-summary-page.description": "Reisevorschläge",
    "itinerary-summary-page.title": "Routenvorschläge",
    "itinerary-summary-row.biking-distance": "Gesamte Fahrradstrecke: {totalDistance}.",
    "itinerary-summary-row.clickable-area-description": "Auf der Karte zeigen",
    "itinerary-summary-row.description": "Route fährt ab {departureDate} {departureTime} mit Ankunft {arrivalDate} {arrivalTime}. {firstDeparture} {transfers} Gesamte Dauer {totalTime}.",
    "itinerary-summary-row.first-departure": "{vehicle} fährt um {departureTime} von {stopName}.",
    ...
    "itinerary-summary-row.transfers": "Umstieg auf {vehicle} an Halt {stopName}",
    "itinerary-summary-row.walking-distance": "Gesamte Laufstrecke: {totalDistance}.",
    "itinerary-summary.bikeAndPublic-fallback-title": "Nehmen Sie Ihr Rad mit ins Fahrzeug",
    "itinerary-summary.bikeAndPublic-rail-subway-title": "Nehmen Sie Ihr Rad mit in den Zug oder die Bahn",
    ...
    "map-layer-vehicles": "Buspositionen (Beta)",
    ...
    "move-on-map": "Bewegen Sie sich auf der Karte",
    "move-to-tab": "Gehen Sie zur Registerkarte {number}",
    "navigate": "Navigieren",
    "nearest": "Nächste",
    "nearest-favorites": "Hält in meiner Nähe an",
    "nearest-favorites-browse-stops": "Durchsuchen und Stopps auswählen",
    "nearest-favorites-no-favorites": "Fahrpläne für die ausgewählten Haltestellen und Fahrzeuge auf der Karte",
    ...
    "nearest-stops-favorite": "Hält in meiner Nähe an",
    ...
    "next": "Nächste",
    "no-bike-allowed-popup-train": "Die Fahrradmitnahme ist in Pendlerzügen erlaubt, in Fernverkehrszügen ist jedoch ein Zuschlag nötig und es könnte eine Reservierung erforderlich sein.",
    "no-bike-allowed-popup-tram-bus": "Die Fahrradmitnahme ist in Bussen und Straßenbahnen nicht erlaubt. Lassen Sie Ihr Fahrrad bitte an der Haltestelle oder an Park&Ride Plätzen, wenn Sie diese Verkehrsmittel benutzen. ",
    ...
    "no-route-end-date-not-in-range": "Der aktuelle Fahrplan enthält keine späteren Abfahrten.",
    ...
    "no-route-msg-with-changes": "Leider wurden keine Reiseoptionen zu Ihrer Anfrage gefunden. Passen Sie Ihre Einstellungen, Abfahrt- oder Zielort an.",
    "no-route-origin-near-destination": "Die Entfernung zwischen Start und Ziel ist sehr gering. Bitte ändern Sie einen dieser Orte.",
    ...
    "no-route-start-date-too-early": "Der aktuelle Fahrplan enthält keine früheren Abfahrten.",
    ...
    "number-of-minutes": "{number, plural, =0 {0 Minuten} one {1 Minute} other {{number} Minuten}}",
    ...
    "origin-outside-service": "Leider konnte keine Route von diesem Startort gefunden werden. Der Startort befindet sich außerhalb des abgedeckten Gebietes. Bitte ändern Sie den Startort.",
    ...
    "route-not-possible": "Leider konnte keine Route berechnet werden. Technischer Fehler: \"{error}\"",
    "route-page.description": "Linie {shortName}, {longName}",
    "route-page.future-routes": "Zukünftige Routen",
    "route-page.pattern-chosen": "Ausgewählt",
    "route-page.pattern-select-title": "Wählen Sie die anzuzeigende Route aus",
    "route-page.special-routes": "Dienstleistungen zu / von Depot- und Umleitungsrouten",
    ...
    "search": "Suchen",
    "search-autosuggest-label": "Ort und Haltestellensuche. Liste mit Pfeiltasten navigieren, mit Enter-Taste auswählen",
    ...
    "select-all-routes": "Wählen Sie alle Routen aus",
    ...
    "select-route": "Wählen Sie {mode} route {shortName} to {headsign}",
    "selected-routes": "Ausgewählte Zeilen",
    "send": "Senden",
    "separate-ticket-required": "Für einen Teil der Route ist ein seperates Ticket erforderlich.",
    "separate-ticket-required-disclaimer": "Die Route umfasst einen oder mehrere Abschnitte, für die {agencyName} keine Tickets verkauft.",
    ...
    "stop-page.right-now.loaded": "Stoppseite geladen",
    ...
    "swipe-disruption-info": "Registerkarten für das Streichen von Störungsinformationen",
    "swipe-disruption-info-header": "Registerkarten für das Streichen von Störungsinformationen.",
    "swipe-message-bar": "Ergebnisregisterkarten für das Durchziehen von Nachrichten",
    "swipe-message-bar-header": "Ergebnisregisterkarten für das Durchziehen von Nachrichten.",
    "swipe-result-tab-left": "Swipe result tabs left arrow. Press Enter or Space to show the previous tab.",
    "swipe-result-tab-right": "Swipe result tabs right arrow. Press Enter or Space to show the next tab.",
    "swipe-result-tabs": "Swipe result tabs. Switch tabs using arrow keys.",
    "swipe-stops-near-you": "Stoppt in Ihrer Nähe und wischt über die Ergebnisregisterkarten.",
    "swipe-stops-near-you-header": "Stoppt in Ihrer Nähe und wischt über die Ergebnisregisterkarten",
    "swipe-summary-page": "Registerkarten für das Wischen der Reiseroute",
    "swipe-summary-page-header": "Registerkarten für das Wischen der Reiseroute.",
    "terminal-page.description": "Terminal - {name}",
    "terminal-page.title": "Terminal",
    "terminal-page.title-short": "Terminal - {name}",
    ...
    "warning-call-agency": "Nur auf Nachfrage: {routeName}, muss vorher angefragt werden.",
    "warning-call-agency-no-route": "Nur auf Nachfrage. Diese Fahrt muss vorher angefragt werden.",
    "weather": "Wetter",
    "weather-at-destination": "Wetter am Reiseziel",
    "wednesday": "Mittwoch",
    "weather-data-source": "Quelle: Finnisches Meteorologisches Institut",
    "weather-detail-title": "Wettervorhersage für den Herkunftsort bei",
    "weather-icon-1": "klar",
    "weather-icon-2": "Teilweise wolkig",
    "weather-icon-21": "Lichtduschen",
    "weather-icon-22": "Duschen",
    "weather-icon-23": "Starker Regen",
    "weather-icon-3": "Bedeckt",
    "weather-icon-31": "Leichter Regen",
    "weather-icon-32": "Regen",
    "weather-icon-33": "Starkregen",
    "weather-icon-41": "Leichte Schneeschauer",
    "weather-icon-42": "Schneeschauer",
    "weather-icon-43": "Starke Schneeschauer",
    "weather-icon-51": "Leichter Schneefall",
    "weather-icon-52": "Schneefall",
    "weather-icon-53": "Starker Schneefall",
    "weather-icon-61": "Gewitter",
    "weather-icon-62": "Schwere Gewitter",
    "weather-icon-63": "Donner",
    "weather-icon-64": "Schwerer Donner",
    "weather-icon-71": "Leichte Schneeregenschauer",
    "weather-icon-72": "Schneeregen Duschen",
    "weather-icon-73": "Schwere Schneeregen",
    "weather-icon-81": "Leichter Schneeregen",
    "weather-icon-82": "Schneeregen",
    "weather-icon-83": "Schwerer Schneeregen",
    "weather-icon-91": "Nebel",
    "weather-icon-92": "Nebel",
    "weekday-fr": "Freitag",
    "weekday-mo": "Montag",
  ...
  "en":{
    ...
    "accept-carpool-policy": "I have read and agreed to the <a href=\"{policyUrl}\" target=\"_blank\">privacy policy</a> and <a href=\"{termsUrl}\" target=\"_blank\">terms of use</a>.",
    "accessibility": "Accessibility",
    "accessibility-limited": "Wheelchair",
    "accessibility-nolimit": "No limits",
    "accessibility-statement": "Accessibility statement",
    "add-carpool-offer-frequency": "How often do you offer this ride?",
    "add-favourite-bikeStation-failed-heading": "Saving the citybike station failed",
    ...
    "add-phone-number": "Please add your phone number:",
    ...
    "alert:bikerental:free-floating-drop-off": "Destination is not a designated drop-off area. Rental cannot be completed here. Please check terms & conditions for additional fees.",
    "all-routes": "All routes",
    "all-routes-disabled": "No routes",
    "approx-meters": "{approxDistance} m",
    "aria-itinerary-summary": "Total journey time {duration}. Departing at {inFuture} {departureTime} and arriving at {arrivalTime}",
    "aria-itinerary-summary-bike-distance": "Total cycling {duration}, {distance} ",
    "aria-itinerary-summary-walk-distance": "Total walking {duration}, {distance} ",
    ...
    "car_park": "Park & ride",
    "carpool": "Carpool",
    "carpool-offer-success": "Your advertisement from {origin} to {destination} has been discontinued.",
    "carpool-success-info": "Your advertisement will be deleted after this time has elapsed at the latest after three months (for regular journeys).",
    ...
    "choose-stop-or-vehicle": "Select vehicle or stop",
    "choose-vehicle": "Select vehicle",
    "chosen-times-once": "You have advertised for the following date and time: ",
    "chosen-times-recurring": "You have advertised for the following time and days: ",
    "citybike": "Sharing",
    ...
    "citybike-return-full-link": "How to return a bike when a bike station is full ›",
    ...
    "destination-label-change": "Change destination",
    "destination-outside-service": "No route suggestions were found because the destination is outside the service area.",
    ...
    "itinerary-details.transit-leg-part-2": "from stop {startStop} {startZoneInfo} {trackInfo} to stop {endStop} {endZoneInfo}. Estimated duration {duration}",
    ...
    "itinerary-summary-row.description": "Itinerary departing at {departureDate} {departureTime} and arriving at {arrivalDate} {arrivalTime}. {firstDeparture} {transfers} Total time {totalTime}.",
    "itinerary-summary-row.first-departure": "{vehicle} leaves at {departureTime} from stop {stopName}.",
    "itinerary-summary-row.first-leg-start-time": "Leaves at {firstDepartureTime} {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform}",
    "itinerary-summary-row.first-leg-start-time-citybike": "Departure at {firstDepartureTime} from {firstDepartureStop} bike station",
    ...
    "itinerary-summary.bikeAndPublic-fallback-title": "Take your bike with you onboard",
    "itinerary-summary.bikeAndPublic-rail-subway-title": "Take your bike with you on the train or to metro",
    "itinerary-summary.bikeAndPublic-rail-title": "Take your bike with you on the train",
    ...
    "itinerary-summary.interline-wait": "Wait for the transfer onboard ({time})",
    ...
    "location-work": "Work",
    "login": "Log in",
    "login-content": "To save and utilize places, routes and stops, you must log in using your HSL account.",
    ...
    "map-layer-carpool": "Ride points",
    "map-layer-citybike": "Citybike stations",
    "map-layer-dynamic-parking-lots": "Parking (& Travel)",
    ...
    "map-layer-vehicles": "Bus positions (Beta)",
    "map-layer-weather-stations": "Road weather",
    "menu-faq": "FAQ",
    ...
    "nearest-favorites-no-favorites": "Timetables for the selected stops and vehicles on map",
    ...
    "no-route-already-at-destination": "You are already at your destination.",
    "no-route-end-date-not-in-range": "The timetable does not include later departures.",
    "no-route-msg": "Unfortunately, no route suggestions were found.",
    "no-route-msg-with-changes": "Unfortunately, no route suggestions were found. Please check your search settings or try changing the origin or destination.",
    "no-route-origin-near-destination": "No route suggestions were found because the origin and destination are very close to each other.",
    "no-route-origin-same-as-destination": "No route suggestions were found because the origin and destination are the same.",
    "no-route-showing-alternative-options": "No route suggestions were found with the your settings. However, we found the following route options:",
    ...
    "or": "or",
    "origin": "Origin",
    "origin-label-change": "Change departure",
    "origin-outside-service": "No route suggestions were found because the origin is outside the service area.",
    ...
    "scooter-distance-duration": "Ride your kick scooter {duration} ({distance})",
    "scooter-register-required": "To use kick scooters, you need to register",
    "scooterwalk-distance-duration": "Walk your kick scooter {duration} ({distance})",
    "search": "Search",
    "search-autosuggest-label": "Venue, place and stopsearch. Navigate list with arrow keys and select with enter key",
    "search-autosuggest-len": "There {len, plural, =1 {is 1 suggestion} other {are {len} suggestions}} available",
    ...
    "stop-near-you-modal-grant-permission-info": "You can enable location services in your phone or browser settings, allowing the service to use your current location.",
    "stop-near-you-modal-header": "You have not enabled location services",
    "stop-near-you-modal-info": "Using the nearby stops function requires location access.",
    ...
    "street-mode-bike-aria": "Show cycle route. Duration {duration}, distance {length}",
    "street-mode-bikeandvehicle-aria": "Show a combination of cycling and public transport. Duration {duration}, distance {length}",
    "street-mode-car": "Car",
    "street-mode-car_park": "Park & ride",
    "street-mode-public_transport": "Public transport",
    "street-mode-walk": "Walking",
    "street-mode-walk-aria": "Show walking route. Duration {duration}, distance {length}",
    "streets": "Streets",
    "subway": "Metro",
    "subway-with-route-number": "Metro {routeNumber} {headSign}",
    "summary-page.description": "{from} - {to}",
    ...
    "swipe-result-tab-left": "left arrow. Press Enter or Space to show the previous tab.",
    "swipe-result-tab-right": "right arrow. Press Enter or Space to show the next tab.",
    ...
    "use-national-service-postfix": ".",
    "use-national-service-prefix": "We recommend you try the national journey planner, ",
    ...
    "walk-bike-itinerary-3": "Your search returned only walking and cycling routes.",
  ...
  "es":{
     ...
     "cyclewalk-distance-duration":"Anda junto a tu bici {duration} ({distance})",
     ...
     "more-departures":"Más salidas",
     "more-settings":"Más configuración",
     "move-on-map":"Moverse en el mapa",
     "navigate":"Navegar",
     "nearest":"Más cercano",
  ...
  "fi":{
     ...
     "add-favourite-bikeStation-failed-heading":"Kaupunkipyöräaseman tallentaminen ei onnistunut",
     ...
     "add-favourite-station-failed-heading":"Aseman tallentaminen ei onnistunut",
     ...
     "add-work":"Lisää työ",
     "aria-itinerary-summary":"Matkan kokonaiskesto {duration}. Lähtö {inFuture} kello {departureTime}. Perillä kello {arrivalTime}.",
     "aria-itinerary-summary-bike-distance":"pyöräilyä yhteensä {duration}, {distance} ",
     "aria-itinerary-summary-walk-distance":"kävelyä yhteensä {duration}, {distance} ",
     ...
     "search-autosuggest-len":" Löydettiin {len, plural, =1 {1 ehdotus} other {{len} ehdotusta}}",
     ...
     "cancel":"Peruuta",
     "canceled":"Peruttu",
     "canceled-itineraries-amount":"Lisäksi {itineraryAmount, plural, =1 {1 peruttu reittiehdotus} other {{itineraryAmount} peruttua reittiehdotusta}}",
     "canceled-itineraries-amount-hide":"Piilota perutut reittiehdotukset ({itineraryAmount})",
     ...
     "citybike-return-full-link":"Näin palautat pyörän, kun pyöräasema on täynnä ›",
     ...
     "departure-is-canceled":"{modeInfo} lähtö {from}–{to} kello {time} on peruttu",
     ...
     "destination-outside-service":"Reittiehdotuksia ei löytynyt, koska määränpää sijaitsee palvelualueen ulkopuolella.",
     ...
     "instructions":"Ohjeet",
     "itinerary-details.biking-leg":"{time} pyöräile kohteesta {origin} {distance} kohteeseen {destination}. Matka-aika {duration}",
     "itinerary-details.car-leg":"{time} aja {distance} kohteesta {origin} kohteeseen {destination}. Matka-aika {duration}",
     ...
     "itinerary-details.scooter-leg":"{time} potkulautaile {distance} kohteesta {origin} kohteeseen {destination}. Matka-aika {duration}",
     "itinerary-details.transit-leg-part-1":"{time} ota",
     "itinerary-details.transit-leg-part-2":"pysäkiltä {startStop} {startZoneInfo} {trackInfo} Pysäkille {endStop} {endZoneInfo}. Arvioitu matka-aika {duration}",
     "itinerary-details.walk-leg":"{time} kävele {distance} kohteesta {origin} kohteeseen {destination}. Matka-aika {duration}",
     ...
     "itinerary-summary-page-street-mode.update-alert":"Kävely ja pyöräily hakutulokset päivitetty",
     "itinerary-summary-page.description":"Reittiehdotukset",
     "itinerary-summary-row.biking-distance":"Pyöräilyä yhteensä {totalDistance}.",
     "itinerary-summary-row.clickable-area-description":"Näytä kartalla",
     "itinerary-summary-row.description":"Lähtö {departureDate} kello {departureTime}. Perillä {arrivalDate} kello {arrivalTime}. {firstDeparture} {transfers} Matka-aika {totalTime}",
     "itinerary-summary-row.first-departure":"{vehicle} lähtee asemalta {stopName} kello {departureTime}.",
     "itinerary-summary-row.first-leg-start-time":"Lähtee klo {firstDepartureTime} {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform}",
     "itinerary-summary-row.first-leg-start-time-citybike":"Lähtö klo {firstDepartureTime} kaupunkipyöräasemalta {firstDepartureStop}",
     ...
     "itinerary-summary-row.walking-distance":"Kävelyä yhteensä {totalDistance}.",
     "itinerary-summary.bikeAndPublic-fallback-title":"Ota pyöräsi mukaan kulkuneuvoon",
     "itinerary-summary.bikeAndPublic-rail-subway-title":"Ota pyöräsi mukaan junaan tai metroon",
     "itinerary-summary.bikeAndPublic-rail-title":"Ota pyöräsi mukaan junaan",
     "itinerary-summary.bikeAndPublic-subway-title":"Ota pyöräsi mukaan metroon",
     ...
     "login-content":"Paikkojen, linjojen ja pysäkkien tallentaminen ja hyödyntäminen edellyttää kirjautumista HSL-tunnuksella!",
     ...
     "nearest-favorites-no-favorites":"Valitsemiesi pysäkkien aikataulut ja ajoneuvot kartalla",
     ...
     "next":"Seuraava",
     "no-bike-allowed-popup-train":"Lähiliikenteen juniin pyörän voi ottaa mukaan ilmaiseksi, mutta pitkän matkan junissa peritään lisämaksu ja mahdollisesti vaaditaan etukäteisvaraus.",
     "no-bike-allowed-popup-tram-bus":"Pyörää ei voi ottaa bussiin tai raitiovaunuun. Jos käytät reitilläsi näitä kulkuvälineitä, jätä pyörä pysäkille tai liityntäpysäköintiin.",
     ...
     "no-route-end-date-not-in-range":"Aikataulu ei sisällä myöhäisempiä reittejä.",
     "no-route-msg":"Reittiehdotuksia ei valitettavasti löytynyt.",
     "no-route-msg-with-changes":"Reittiehdotuksia ei valitettavasti löytynyt. Ole hyvä ja tarkasta asettamasi hakuasetukset tai yritä muuttaa lähtöpaikkaa tai määränpäätä.",
     "no-route-origin-near-destination":"Reittiehdotuksia ei löytynyt, koska lähtöpaikka ja määränpää ovat niin lähellä toisiaan.",
     "no-route-origin-same-as-destination":"Reittiehdotuksia ei löytynyt, koska lähtöpaikka on sama kuin määränpää.",
     "no-route-showing-alternative-options":"Asettamillasi asetuksilla ei löytynyt yhtään reittiehdotusta. Löysimme kuitenkin seuraavia reittivaihtoehtoja:",
     ...
     "origin-outside-service":"Reittiehdotuksia ei löytynyt, koska lähtöpaikka sijaitsee palvelualueen ulkopuolella.",
     ...
     "scooter-register-required":"Potkulautojen käyttö vaatii rekisteröitymisen",
     "scooterwalk-distance-duration":"Taluta potkulautaa {duration} ({distance})",
     "search":"Etsi",
     ...
     "send":"Lähetä",
     "separate-ticket-required":"Tälle matkan osuudelle tarvitaan erillinen lippu.",
     "separate-ticket-required-disclaimer":"Matka sisältää yhden tai useamman osuuden, jonka lippujen myynnistä {agencyName} ei vastaa.",
     ...
     "stop-near-you-modal-grant-permission-info":"Voit sallia paikannuksen selaimen tai puhelimen asetuksista, jolloin palvelu pystyy hyödyntämään nykyistä sijaintiasi.",
     "stop-near-you-modal-header":"Et ole sallinut paikannusta",
     "stop-near-you-modal-info":"Lähipysäkkien käyttö edellyttää tietoa sijainnista.",
     ...
     "stops":"Pysäkit",
     "stops-near-you.description":"Lähialueesi pysäkkiaikataulut ja ajoneuvot kartalla.",
     "stops-near-you.title":"Lähipysäkkien aikataulut",
     "street-mode-bicycle":"Pyöräily",
     "street-mode-bike-aria":"Näytä pyöräilyreitti. Kesto {duration}, pituus {length}",
     "street-mode-bikeandvehicle-aria":"Näytä pyöräilyn ja julkisen liikenteen yhdistelmä. Kesto {duration}, pyöräilyn pituus {length}",
     "street-mode-car":"Auto",
     "street-mode-car_park":"Liityntä\u00ADpysäköinti",
     "street-mode-public_transport":"Julkinen liikenne",
     "street-mode-walk":"Kävely",
     "street-mode-walk-aria":"Näytä kävelyreitti. Kesto {duration}, pituus {length}",
     "street":"Katu",
     "subway":"Metro",
     "subway-with-route-number":"Metro {routeNumber} {headSign}",
     "summary-page.description":"{from} - {to}",
     ...
     "swipe-result-tab-left":"navigointipainike. Näytä edellinen välilehti painamalla enteriä tai välilyöntiä.",
     "swipe-result-tab-right":"navigointipainike. Näytä seuraava välilehti painamalla enteriä tai välilyöntiä.",
     ...
     "use-national-service-prefix":"Suosittelemme kokeilemaan reittihakua koko maan kattavasta ",
     ...
     "walk":"kävelyn",
     "walk-bike-itinerary-1":"Löysimme valitsemallesi reitille vain kävelyyn liittyviä reittiehdotuksia.",
     "walk-bike-itinerary-2":"Löysimme valitsemallesi reitille vain pyöräilyyn liittyviä reittiehdotuksia.",
     "walk-bike-itinerary-3":"Löysimme valitsemallesi reitille vain kävelyyn ja pyöräilyyn liittyviä reittiehdotuksia.",
  ...
  "fr":{
     ...
     "cyclewalk-distance-duration":"Avancer pied à terre sur {duration} ({distance})",
     ...
     "more-departures":"Plus de départs",
     "more-settings":"Plus de paramètres",
     "move-on-map":"Se déplacer sur la carte",
     "navigate":"Voyager",
  ...
  "ro":{
     ...
     "add-via-duration-button-label-close":"Închideți selectorul de durată a staționării la punctul intermediar {index}",
     "add-via-duration-button-label-open":"Deschideți selectorul de durată a staționării la punctul intermediar {index}",
     "arrive-leave":"Ajungeți sau plecați la ora selectată",
     "search-autosuggest-label":"Locații, adrese, stații. Selectați cu mouse-ul sau alegeți din săgețile tastaturii.",
     ...
     "airport-security-check-go-to-gate":"Mergeți spre poartă, trecând prin controlul de securitate",
     "all-routes":"Toate",
     ...
     "cancel":"Anulare",
     "canceled":"Anulat",
     "canceled-itineraries-amount":"Și {itineraryAmount, plural, =1 {un itinerar} alte {{itineraryAmount} itinerarii anulate}}",
     "canceled-itineraries-amount-hide":"Ascunde itinerarii anulate ({itineraryAmount})",
     ...
     "cyclewalk-distance-duration":"Împingeți bicicleta {duration} ({distance})",
     ...
     "destination-outside-service":"Nu am găsit legături între aceste locații. Căutați în interiorul ariei de serviciu.",
     ...
     "disclaimer":"Luați în calcul faptul că datele prezentate sunt estimări. Nu garantăm că veți prinde exact aceste legături.",
     "disruption":"Incident",
     "disruption-info":"Incidente pe traseu",
     "disruption-info-no-alerts":"Nu se cunosc incidente sau detururi.",
     "disruption-info-route-no-alerts":"Nu se cunosc incidente sau detururi pe acest traseu.",
     ...
     "geolocation-denied-text":"Nu ați permis accesul la datele de localizare. Puteți schimba acest lucru în preferințele browserului.",
     "geolocation-failed-heading":"Localizarea a eșuat",
     "geolocation-failed-text":"Browserul nu suportă servicii de localizare.",
     "geolocation-prompt-text":"Vă rugăm să acceptați cererea browserului privind localizarea.",
     "geolocation-timeout-heading":"Durează mai mult decât ar trebui să detectăm locația.",
     "geolocation-timeout-text":"Ați acceptat cererea de permitere a localizării?",
     ...
     "itinerary-details.biking-leg":"La {time} pedalați {distance} de la {origin} la {destination}. Va dura aproximativ {duration}",
     "itinerary-details.car-leg":"La {time} conduceți {distance} de la {origin} la {destination}. Va dura aproximativ {duration}",
     "itinerary-details.end-leg":"La {time} ajungeți la destinație {destination}.",
     ...
     "itinerary-details.scooter-leg":"La {time} mergeți pe trotineta închiriată {distance} de la {origin} la {destination}. Va dura aproximativ {duration}",
     "itinerary-details.transit-leg-part-1":"La {time} luați",
     "itinerary-details.transit-leg-part-2":"de la stația {startStop} {trackInfo} până la stația {endStop}. Va dura aproximativ {duration}",
     "itinerary-details.walk-leg":"At {time} mergeți pe jos {distance} de la {origin} la {destination}. Va dura aproximativ {duration}",
     ...
     "itinerary-summary-row.biking-distance":"Distanța totală de pedalat {totalDistance}.",
     "itinerary-summary-row.clickable-area-description":"Afișați pe hartă",
     "itinerary-summary-row.description":"Itinerarul cu plecare la {departureDate} {departureTime} și sosire la {arrivalDate} {arrivalTime}. {firstDeparture} {transfers} Timp total {totalTime}.",
     "itinerary-summary-row.first-departure":"{vehicle} pleacă la {departureTime} de la {stopName}.",
     "itinerary-summary-row.transfers":"Schimbați cu {vehicle} la {stopName}",
     "itinerary-summary-row.walking-distance":"Distanța totală de mers pe jos {totalDistance}.",
     ...
     "likely-to-recommend":"Cât de probabil e să recomandați acest serviciu prietenilor sau familiei?",
     "likely-to-use":"Cât de probabil ar fi să folosiți acest planificator de călătorie față de cel curent?",
     "loading":"Se încarcă...",
     "localadmin":"Locality",
     ...
     "move-on-map":"Deplasați-vă pe hartă",
     "navigate":"Navigare",
     "nearest":"Cel mai aproape",
     "network-error":"Eroare de rețea",
     "neighbourhood":"Cartier ",
     "next":"Următorul",
     "no-bike-allowed-popup-train":"Bicicletele sunt permise în trenurile de navetă, însă e posibil să aveți nevoie de un bilet suplimentar sau de rezervare prealabilă.",
     "no-bike-allowed-popup-tram-bus":"Bicicletele nu sunt permise în tramvai și autobuz. Lăsați bicicleta într-un rastel sau o parcare dacă o folosiți pe ruta dumneavoastră.",
     "no-departures":"Nu am găsit plecări.",
     "no-position":"Nicio locație.",
     "no-position-no-stops":"Nu v-am găsit locația. Nu putem afișa stații în zonă.",
     ...
     "no-route-msg":"Nu s-a găsit nicio rută conform selecției. Schimbați punctul de plecare sau destinație.",
     "no-route-msg-with-changes":"Nu s-a găsit nicio rută conform selecției. Schimbați plecarea, destinația sau parametrii introduși ca preferințe.",
     "no-route-origin-near-destination":"Plecarea și destinația sunt în puncte prea apropiate. Vă rugăm să mutați una din ele.",
     ...
     "now":"Now",
     "number-of-intermediate-stops":"{number, plural, =0 {Nicio stație intermediară} O {1 stație} altă {{number} opriri} }",
     "number-of-minutes":"{number, plural, =0 {0 minute} Un {1 minut} alt {{number} minute}}",
     "off-canvas-info":"Autentificați-vă pe platformă pentru a vă salva locațiile favorite și a le putea utiliza pe alte dispozitive.",
     ...
     "scooterwalk-distance-duration":"Împingeți trotineta {duration} ({distance})",
     "search":"Caută",
     "search-button-label":"Caută",
     "search-destination":"Căutați punctul de plecare, ruta sau stația",
     "search-destination-index":"Enter destination",
     "search-destination-results-but-no-search":"Vedeți rezultatele în fereastra “Destinație”",
     "search-no-results":"Nicio locație",
     "search-origin":"Căutați destinația, ruta sau stația",
     "search-origin-index":"Enter origin",
     "search-position":"Detectați locația",
     "search-search-results-but-no-destination":"Vedeți rezultatele în fereastra “Despre rută sau stație”",
     ...
     "send":"Trimite",
     "separate-ticket-required":"Un bilet separat e necesar pentru o parte din acest itinerar.",
     "separate-ticket-required-disclaimer":"Acest itinerar conține una sau mai multe rute pentru care {agencyName} nu comercializează bilete.",
     "settings":"Setări",
     ...
     "warning-call-agency":"Doar la cerere: {routeName}, trebuie rezervată în avans vorbind cu compania.",
     "warning-call-agency-no-route":"Doar la cerere! Trebuie stabilit cu compania în avans.",
  ...
  "sv":{
     ...
     "add-favourite-bikeStation-failed-heading":"Kunde inte spara stadscykelstationen",
     ...
     "add-via-duration-button-label-close":"Stäng väljaren för varaktighet vid via-punkten",
     "add-via-duration-button-label-open":"Öppna väljaren för varaktighet vid via-punkten",
     "add-work":"Lägg till arbete",
     "aria-itinerary-summary":"Den totala restiden {duration}. Avgång {inFuture} klockan {departureTime}. Framme klockan {arrivalTime}",
     "aria-itinerary-summary-bike-distance":"cykling sammanlagt {duration}, {distance}",
     "aria-itinerary-summary-walk-distance":"promenad sammanlagt {duration}, {distance}",
     "arrive-leave":"Anländer eller lämnar vid vald tid",
     "search-autosuggest-label":"Plats, linje och hållplatssökning. Navigera listan med piltangenterna och välj med Enter-tangeten",
     ...
     "cancel":"Avbryt",
     "canceled":"Inställt",
     "canceled-itineraries-amount":"Ytterligare {itineraryAmount, plural, =1 {1 avställt avgång} other {{itineraryAmount} avställda avgångar}}",
     "canceled-itineraries-amount-hide":"Dölja inställda reseförslag ({itineraryAmount})",
     ...
     "choose-vehicle":"Select vehicle",
     "citybike":"Stadscykel",
     "citybike-buy-season":"Köp ett abonnemang för en dag, en vecka eller för en hel säsong",
     ...
     "citybike-return-full-link":"Så här återlämnar du cykeln till en fullsatt cykelstation ›",
     ...
     "delete":"Ta bort",
     "delete-favourite-failed-heading":"Unable to delete save",
     "departure-is-canceled":"Avgång på {modeInfo} {from}–{to} kl. {time} är inställd",
     ...
     "itinerary-details.biking-leg":"{time} cykla {distance} från {origin} till destinationen {destination}. Restid {duration}",
     "itinerary-details.car-leg":"{time} kör {distance} från {origin} till destinationen {destination}. Restid {duration}",
     "itinerary-details.end-leg":"{time} du anländer till destinationen {destination}",
     "itinerary-details.route-has-info-alert":"Det finns meddelanden som gäller rutten.",
     ...
     "itinerary-details.scooter-leg":"{time} sparkcykla {distance} från {origin} till destinationen {destination}. Restid {duration}",
     "itinerary-details.transit-leg-part-1":"{time} ta",
     "itinerary-details.transit-leg-part-2":"från hållplats {startStop} {startZoneInfo} {trackInfo} till hållplats {endStop} {endZoneInfo}. Beräknad restid {duration}",
     "itinerary-details.walk-leg":"{time} promenera {distance} från {origin} till destinationen {destination}. Restid {duration}",
     ...
     "itinerary-summary-row.biking-distance":"Cykling sammanlagt {totalDistance}.",
     "itinerary-summary-row.clickable-area-description":"Visa på kartan",
     "itinerary-summary-row.description":"Avgång {departureDate} klockan {departureTime}. Framme {arrivalDate} klockan {arrivalTime}. {firstDeparture} {transfers} Restid {totalTime}.",
     "itinerary-summary-row.first-departure":"{vehicle} avgår från station {stopName} klockan {departureTime}.",
     "itinerary-summary-row.first-leg-start-time":"Avgår kl {firstDepartureTime} {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform}",
     "itinerary-summary-row.first-leg-start-time-citybike":"Avgång kl {firstDepartureTime} från {firstDepartureStop} stadscykelstation",
     "itinerary-summary-row.no-transit-legs":"Avgå när det passar för dig",
     "itinerary-summary-row.transfers":"Byte {vehicle} vid hållplats {stopName}",
     "itinerary-summary-row.walking-distance":"Promenad sammanlagt {totalDistance}.",
     "itinerary-summary.bikeAndPublic-fallback-title":"Ta cykeln med dig i fordonet",
     "itinerary-summary.bikeAndPublic-rail-subway-title":"Ta cykeln med på tåget eller metron",
     ...
     "itinerary-summary.bikePark-title":"Lämna din cykel till anslutningsparkeringen",
     ...
     "login":"Logga in",
     "login-content":"För att kunna spara och utnyttja platser, linjer och hållplatser ska du logga in med ditt HRT-konto!",
     ...
     "nearest-favorites-no-favorites":"Tidtabeller och fordon vid de valda hållplatserna på kartan",
     ...
     "next":"Nästa",
     "no-bike-allowed-popup-train":"Du kan ta med cykeln i närtågen avgiftsfritt, men i andra tåg är det avgiftsbelagt och kräver möjligtvis en förhandsreservation.",
     "no-bike-allowed-popup-tram-bus":"Cyklar är inte tillåtna i bussar eller spårvagnar. Om du använder dessa fordon på din färd, lämna cykeln vid hållplatsen eller vid infartsparkeringen.",
     ...
     "no-route-msg-with-changes":"Kunde tyvärr inte hitta ruttförslag Var god och kontrollera dina val eller försök ändra avgångsplats eller destination.",
     "no-route-origin-near-destination":"Kunde inte hitta ruttförslag eftersom avgångsplatsen och destinationen ligger för nära varandra.",
     "no-route-origin-same-as-destination":"Kunde inte hitta ruttförslag eftersom avgångsplatsen är densamma som destinationen.",
     "no-route-showing-alternative-options":"Kunde inte hitta några ruttförslag med dina val. Vi hittade dock följande ruttalternativ:",
     "no-route-start-date-too-early":"I tidtabellen ingår inte tidigare rutter.",
     ...
     "origin-outside-service":"Kunde inte hitta ruttförslag eftersom avgångsplatsen ligger utanför vårt serviceområde.",
     ...
     "route-page.special-routes":"Turer som kör till/från depån och avvikande rutter",
     ...
     "scooter-register-required":"Det krävs registrering för att kunna använda sparkcyklar",
     ...
     "send":"Skicka",
     "separate-ticket-required":"Denna etapp av resan kräver en separat biljett.",
     "separate-ticket-required-disclaimer":"Resan består av en eller fleta etapper vilka kräver biljetter som inte säljs av {agencyName}.",
     ...
     "stop-near-you-modal-grant-permission-info":"Du kan aktivera positionering i inställningar så att tjänsten kan använda din position.",
     "stop-near-you-modal-header":"Du har inte aktiverat positionering",
     "stop-near-you-modal-info":"Användning av funktion ”hållplatserna nära dig” förutsätter information om din position.",
     ...
     "street-mode-bikeandvehicle-aria":"Visa kombinationen av cykling och kollektivtrafik. Tid {duration}, längd {length}",
     "street-mode-car":"Bil",
     "street-mode-car_park":"Infarts\u00ADparkering",
     "street-mode-public_transport":"Kollektiv\u00ADtrafik",
     "street-mode-walk":"Gång",
     "street-mode-walk-aria":"Visa promenadrutt. Tid {duration}, längd {length}",
     "street":"Gata",
     "subway":"Metro",
     "subway-with-route-number":"Metro {routeNumber} {headSign}",
     "summary-page.description":"{from} - {to}",
     ...
     "swipe-result-tab-left":"Gå till föregående blad genom att trycka på enter eller mellanslag.",
     "swipe-result-tab-right":"Gå till följande blad genom att trycka på enter eller mellanslag.",
     "swipe-result-tabs":"Bläddra mellan blad med pilknapparna.",
     "swipe-stops-near-you":"Navigeringsknapp för att kunna bläddra hållplatser nära mig.",
     ...
     "use-national-service-prefix":"Vi rekommenderar att du använder ruttsökning",
     ...
     "walk":"gång",
     "walk-bike-itinerary-1":"Vi har endast hittat ruttförslag i vilka ingår promenad.",
     "walk-bike-itinerary-2":"Vi har endast hittat ruttförslag i vilka ingår cykling.",
     "walk-bike-itinerary-3":"Vi har endast hittat ruttförslag i vilka ingår promenad och cykling.",
     "walk-distance-duration":"Gå {duration} ({distance})",
     "walking":"Gång",
