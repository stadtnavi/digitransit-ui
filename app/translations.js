...
const translations = {
  ...
  de: {
    ...
    'phasepicker.phase': 'Phase {phase}: Lenkungspunkt {name}',
    'position': 'Position',
    ...
    'index.searchIntro': 'Die neue Lenkung des Autoverkehrs wurde im November 2023 politisch beschlossen. Durch die Einrichtung von drei Lenkungspunkten ergeben sich neue Wege für den Autoverkehr.  Sieh schon jetzt was sich für dich ändert.',
  ...
  en: {
    ...
    'index.searchIntro': 'The new traffic management for car traffic was politically decided in November 2023. By establishing three control points, new routes for car traffic are created. See now what changes for you.',
    ...
    'phasepicker.phase': 'Phase {phase}: Control Point {name}',
  ...
  fr: {
    ...
    imprint: "Empreinte", 
    "in-addition": "En plus", 
    'index.searchIntro': 'Le nouveau contrôle de la circulation automobile a été décidé par la politque en novembre 2023. Grâce à la mise en place de trois points de pilotage, de nouveaux itinéraires sont créés pour la circulation automobile. Vois dès maintenant ce qui change pour toi.',
    ...
    'phasepicker.phase': 'Phase {phase}: Point de pilotage {name}',
 ...
 pl: {
  ...
  nl: {
    ...
    'index.searchIntro': 'De nieuwe regeling van het autoverkeer werd in november 2023 politiek besloten. Door het instellen van drie regelpunten ontstaan er nieuwe routes voor het autoverkeer. Zie nu al wat er voor jou verandert.',
    ...
    'phasepicker.phase': 'Fase {phase}: Regelpunt {name}',
