Digitransit-ui is a React based web application. The following bullet point describe the graphgrapharchitecture on a overview level and provide guidelines on how the code should be.
