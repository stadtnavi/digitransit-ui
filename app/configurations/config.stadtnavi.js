...
const MAP_URL =
  process.env.MAP_URL ||
  'https://tiles-eu.stadtnavi.eu/styles/streets/{z}/{x}/{y}{r}.png';
const BIKE_MAP_URL =
  process.env.BIKE_MAP_URL ||
  'https://tiles-eu.stadtnavi.eu/styles/bicycle/{z}/{x}/{y}{r}.png';

const SEMI_TRANSPARENT_MAP_URL =
  process.env.SEMITRANSPARENT_MAP_URL ||
  'https://tiles-eu.stadtnavi.eu/styles/satellite-overlay/{z}/{x}/{y}{r}.png';
const GEOCODING_BASE_URL =
  process.env.GEOCODING_BASE_URL || 'https://photon-eu.stadtnavi.eu/pelias/v1';
...
export default configMerger(parentConfig, {
  ...
  map: {
    ...
    attribution: {
      ...
      satellite:
        '© <a tabindex=-1 href=http://osm.org/copyright>OpenStreetMap Mitwirkende</a>, © <a tabindex=-1 href="https://www.lgl-bw.de/">LGL BW</a>, <a tabindex=-1 href=https://www.nvbw.de/aufgaben/digitale-mobilitaet/open-data/>Datensätze der NVBW GmbH</a> und <a tabindex=-1 href=https://www.openvvs.de/dataset/gtfs-daten>VVS GmbH</a>',
      bicycle:
