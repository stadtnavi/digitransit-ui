...
const translations = {
  ...
  de: {
    ...
    'departure-is-canceled-rail': 'S-Bahn/Zug {shortName}',
    ...
    map: 'Karte',
    'map-layer-carpool': 'Fahrgemeinschaft',
    ...
    'parking-spaces-available': '{free} von {total} Parkplätzen verfügbar',
    'parking-spaces-in-total': 'Kapazität: {total} Parkplätze',
    ...
    rail: 'S-Bahn / Zug',
    'rail-with-route-number': 'S-Bahn/Zug {routeNumber} {headSign}',
    realtime: 'Echtzeit',
  ...
  en: {
    ...
    'parking-spaces-in-total': 'Capacity: {total} parking spaces',
    'pay-attention': 'N.B.',
