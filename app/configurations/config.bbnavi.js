...
const SEMI_TRANSPARENT_MAP_URL =
  process.env.SEMITRANSPARENT_MAP_URL ||
  'https://tiles.stadtnavi.eu/satellite-overlay/{z}/{x}/{y}{r}.png';
const GEOCODING_BASE_URL =
  process.env.GEOCODING_BASE_URL || 'https://photon.stadtnavi.eu/pelias/v1';
const YEAR = 1900 + new Date().getYear();
const STATIC_MESSAGE_URL =
  process.env.STATIC_MESSAGE_URL || '/assets/messages/message.bbnavi.json';
...
export default configMerger(walttiConfig, {
  ...
  URL: {
    ...
    MAP: {
      default:
        'https://isk.geobasis-bb.de/mapproxy/webatlasde_topplus/service/wms',
      osm: MAP_URL,
      satellite:
        'https://isk.geobasis-bb.de/mapproxy/dop20c_sentinel/service/wms',
      satellite_eu:
        'https://isk.geobasis-bb.de/mapproxy/dop20c_sentinel/service/wms?eu',
    ...
    CHARGING_STATION_DETAILS_API:
      'https://ocpdb.bbnavi.de/api/ocpi/2.2/location/',
  ...
  map: {
    ...
    attribution: {
      default:
        '© GeoBasis-DE/LGB, <a tabindex=-1 href="https://www.govdata.de/dl-de/by-2-0">dl-de/by-2-0</a>, © Geoportal Berlin, <a tabindex=-1 href="https://www.govdata.de/dl-de/by-2-0">dl-de/by-2-0</a>, © <a tabindex=-1 href="https://gdz.bkg.bund.de">BKG</a>, © <a tabindex=-1 href="https://www.openstreetmap.org/copyright">OpenStreetMap-Mitwirkende</a>, <a tabindex=-1 href="https://www.vbb.de/vbb-services/api-open-data/datensaetze/">VBB</a> ',
      osm:
        '© <a tabindex=-1 href="https://www.openstreetmap.org/copyright">OpenStreetMap-Mitwirkende</a>, <a tabindex=-1 href="https://www.vbb.de/vbb-services/api-open-data/datensaetze/">VBB</a> ',
      satellite:
        '© GeoBasis-DE/LGB, <a tabindex=-1 href="https://www.govdata.de/dl-de/by-2-0">dl-de/by-2-0</a>, © Geoportal Berlin, <a tabindex=-1 href="https://www.govdata.de/dl-de/by-2-0">dl-de/by-2-0</a>, © <a tabindex=-1 href="https://www.openstreetmap.org/copyright">OpenStreetMap-Mitwirkende</a>, <a tabindex=-1 href="https://www.vbb.de/vbb-services/api-open-data/datensaetze/">VBB</a> ',
      bicycle:
        '© <a tabindex=-1 href="https://www.openstreetmap.org/copyright">OpenStreetMap-Mitwirkende</a>, © <a tabindex=-1 href="https://www.cyclosm.org/#map=12/52.3728/4.8936/cyclosmx">CyclOSM</a>, © <a tabindex=-1 href="https://www.openstreetmap.fr/">OSM-FR</a>, <a tabindex=-1 href="https://www.vbb.de/vbb-services/api-open-data/datensaetze/">VBB</a>',
    },
    ...
    translations: {
      de: {
        ...
        privacyPolicy: {
          name: 'hier',
          text:
            'Weitere Informationen zum Umgang mit Cookies und unsere Datenschutzerklärung finden Sie {privacyPolicy}.',
        },
        purposes: {
          functional: {
      ...
      en: {
        ...
        privacyPolicy: {
          name: 'here',
          text:
            'For more information on how we handle cookies and our privacy policy, please see {privacyPolicy}.',
        },
        purposes: {
          functional: {
            title: 'Necessary cookies',
            description:
              'These cookies are needed for the smooth functioning of our website.',
          },
        },
        service: {
          required: {
