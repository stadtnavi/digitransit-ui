...
const translations = {
  ...
  de: {
    ...
    'phasepicker.new-routes': 'Neue Routen',
    'phasepicker.phase': 'Phase {phase}: Lenkungspunkt {name} ({from} {starting})',
    'phasepicker.starting-in': 'in',
    'phasepicker.starting-from': 'ab',
    'position': 'Position',
    ...
    'map-layer-sharing-car': 'Carsharing & Taxi-Stationen',
    ...
    'car-distance-duration': 'Fahren ca. {duration} ({distance})',
    'car-only': 'Nur PKW',
    ...
    disclaimer:
      'Die Fahrzeitangaben verlängern sich bei höheren Verkehrsbelastungen.',
    disruption: 'Störung',
    ...
    'index.searchIntro': 'Mit dem Zukunftsrouting können Sie schon heute ausprobieren, wie sich zukünftige Verkehrsführungen in Aachen auf Ihre Route auswirken. Hierfür werden ausgewählte künftige temporäre Änderungen – etwa durch Großbaustellen oder Straßensperrungen – sowie dauerhafte Anpassungen der Verkehrsführung in das Routing integriert. So können Sie sich frühzeitig auf kommende Verkehrssituationen einstellen und alternative Routen kennenlernen.<br/><br/>Für das Routing im aktuellen Straßennetz steht Ihnen das Stadtnavi Aachen zur Verfügung: <a href="https://stadtnavi.aachen.de">stadtnavi.aachen.de</a>',
    ...
    'car-availability': 'Carsharing-Fahrzeuge verfügbar',
    'car-start-using': 'Buchen Sie ein Carsharing-Fahrzeug',
    'car-using-info': 'Mehr Informationen bei',
    'cargo_bicycle-availability': 'Lastenräder verfügbar',
  ...
  en: {
    ...
    'car-availability': 'Shared cars available',
    ...
    'cargo_bicycle-availability': 'Cargo bikes available at the station right now',
    ...
    'car-distance-duration': 'Drive ca. {duration} ({distance})',
    'car-only': 'Car only',
    ...
    disclaimer:
      'Travel times may be longer in the event of higher traffic loads.',
    ...
    'index.searchIntro': 'With "Zukunftsrouting", you can see today how future traffic patterns in Aachen will affect your route. To do this, selected future temporary changes - such as those caused by major construction sites or road closures - as well as permanent adjustments to traffic patterns are integrated into the routing. This allows you to prepare for upcoming traffic situations early on and explore alternative routes. <br/><br/>For routing within the current road network, you can use stadtnavi Aachen: <a href="https://stadtnavi.aachen.de">stadtnavi.aachen.de</a>',
    ...
    'phasepicker.new-routes': 'New Directions',
    'phasepicker.phase': 'Phase {phase}: Control Point {name} ({from} {starting})',
    'phasepicker.starting-in': 'in',
    'phasepicker.starting-from': 'from',
  ...
  fr: {
    ...
    car: "Voiture", 
    "car-availability": "Voitures partagées disponibles", 
    "car-charging-station": "Station de recharge pour voitures", 
    "car-distance-duration": "Conduire ca. {duration} ({distance})", 
    ...
    "cargo_bicycle-availability": "Vélos cargo disponibles à la station dès maintenant", 
    ...
    "citybike-start-using": "Commencez à utiliser des vélos urbains", 
    "citybike-start-using-info": "Informations supplémentaires", 
    "citybike-station": "Station cyclable {stationId}", 
    "citybike-station-no-id": "Station cyclable", 
    ...
    direction: "À", 
    disclaimer: "Les temps de trajet peuvent être plus longs en cas de charges de trafic plus élevées.", 
    ...
    imprint: "Empreinte", 
    "in-addition": "En plus", 
    'index.searchIntro': 'Grâce au calcul d’itinéraire prospectif, vous pouvez dès aujour’hui découvrir l’impact des futurs aménagements de circulation à Aix-la-Chapelle sur votre trajet. Pour cela, certaines modifications temporaires à venir – liées par exemple à de grands chantiers ou à des fermetures de routes – ainsi que des changements permanents dans la circulation sont intégrés dans le calcul d’itinéraire. Vous pouvez ainsi vous adapter à l’avance aux situations de circulation à venir et découvrir des itinéraires alternatifs. <br/><br/>Pour le calcul d’itinéraires sur le réseau routier actuel, vous pouvez utiliser le Stadtnavi Aachen : <a href="https://stadtnavi.aachen.de">stadtnavi.aachen.de</a>',
    ...
    "map-layer-category-bicycle": "Vélo", 
    "map-layer-category-car": "Voiture", 
    "map-layer-category-others": "Autres", 
    ...
    "map-layer-datahub-bike-rentals": "Location de vélos", 
    "map-layer-datahub-bike-repair-shops": "Magasins de réparation de vélos", 
    "map-layer-datahub-e-bike-charging-stations": "Stations de recharge des vélos électriques", 
    "map-layer-datahub-e-bike-rentals": "Location de vélos électriques", 
    ...
    'phasepicker.new-routes': 'Nouvelles routes',
    'phasepicker.phase': 'Phase {phase}: Point de pilotage {name} ( {from} {starting} )',
    'phasepicker.starting-in': 'en',
    'phasepicker.starting-from': 'à partir de',
    ...
    run: "Lancer", 
    save: "Enregistrer", 
    "scooter-availability": "Scooters disponibles à la station en ce moment", 
 ...
 pl: {
  ...
  nl: {
    ...
    "car-availability": "Gedeelde auto's beschikbaar", 
    ...
    "map-layer-category-bicycle": "Fiets", 
    "map-layer-category-sharing": "Delen", 
    "map-layer-category-car": "Auto", 
    "map-layer-category-others": "Overige", 
    ...
    "cargo_bicycle-availability": "bakfietsen beschikbaar", 
    ...
    "bikes-available": "{amount} Fietsen beschikbaar", 
    ...
    "car-distance-duration": "Rijden ca. {duration} ({distance})", 
    ...
    "citybike-start-using": "Beginnen met stadsfietsen", 
    "citybike-start-using-info": "Meer informatie", 
    ...
    "digitransit-platform": "Digitransit service platform", 
    disclaimer: "De reistijden kunnen hoger zijn in het geval van hogere verkeersbelastingen.", 
    disruption: "Storing", 
    ...
    'index.searchIntro': 'Met de ‘toekomstige routebepaling’ kunt u nu al uitproberen hoe toekomstige verkeersmaatregelen in Aken van invloed zijn op uw route. Hiervoor worden geselecteerde toekomstige tijdelijke wijzigingen – bijvoorbeeld door grote bouwplaatsen of wegafsluitingen – en permanente aanpassingen van de verkeersregeling in de routebepaling meegenomen. Zo kunt u zich tijdig voorbereiden op toekomstige verkeerssituaties en alternatieve routes ontdekken. <br/><br/>Voor routebepaling binnen het huidige wegennet kunt u gebruikmaken van de stadtnavi Aachen: <a href="https://stadtnavi.aachen.de">stadtnavi.aachen.de</a>',
    ...
    "map-layer-datahub-bike-rentals": "Fietsverhuurstations", 
    "map-layer-datahub-bike-repair-shops": "Fietsreparatie werkplaatsen", 
    "map-layer-datahub-e-bike-charging-stations": "E-bike oplaadpunten", 
    "map-layer-datahub-e-bike-rentals": "E-bike verhuur", 
    ...
    'phasepicker.new-routes': 'Nieuwe verkeersroutering',
    'phasepicker.phase': 'Fase {phase}: Regelpunt {name} ({from} {starting})',
    'phasepicker.starting-in': 'in',
    'phasepicker.starting-from': 'vanaf',
    ...
    run: "Uitvoeren", 
    save: "Opslaan", 
    "scooter-availability": "Scooters zijn nu beschikbaar op het station", 
